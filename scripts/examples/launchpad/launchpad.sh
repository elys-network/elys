...
elysd query launchpad return-elys-estimation 1 50000
...
# Buy Elys
elysd tx launchpad buy-elys uusdc 1000000 --from=treasury --keyring-backend=test --chain-id=elystestnet-1 --yes --gas=1000000
...
# Withdraw raised
elysd tx launchpad withdraw-raised 1000000uusdc --from=treasury --keyring-backend=test --chain-id=elystestnet-1 --yes --gas=1000000
