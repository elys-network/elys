...
elysd tx oracle add-asset-info-proposal satoshi BTC BTC "" "" --title="title" --description="description" --deposit="10000000000000000000uelys" --from=alice --chain-id=elys --broadcast-mode=block --yes
elysd tx oracle remove-asset-info-proposal satoshi --title="title" --description="description" --deposit="10000000000000000000uelys" --from=alice --chain-id=elys --broadcast-mode=block --yes
