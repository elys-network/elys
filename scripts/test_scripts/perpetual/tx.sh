...
# echo "Tx: Create Pool"
# $BINARY tx amm create-pool 100uedenb,100uusdc 100000000000uedenb,100000000000uusdc uusdc --use-oracle=true --from=$MY_VALIDATOR_ADDRESS --keyring-backend=test --chain-id=elys --gas=1000000
...
# $BINARY tx perpetual open long 2 1 uatom 1000000uusdc --take-profit 45 --from=$MY_VALIDATOR_ADDRESS --keyring-backend=test --chain-id=elys --gas=1000000
...
# $BINARY tx perpetual open short 5 1 uatom 1000000uusdc --take-profit 1 --stop-loss 12 --from=$MY_VALIDATOR_ADDRESS --keyring-backend=test --chain-id=elys --gas=1000000
...
$BINARY tx perpetual close 1 10000000000000 --from=my_validator --keyring-backend=test --chain-id=elys --gas=1000000