...
$BINARY tx gov submit-proposal ${current_dir}/scripts/test_tx_query/burner/update_params.json --from=$MY_VALIDATOR_ADDRESS --keyring-backend=test --chain-id=elys --gas=1000000
