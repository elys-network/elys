...
elysd tx incentive update-pool-info "$poolIds" "$multipliers" --title="title" --description="description" --deposit="10000000uelys" --from=treasury --chain-id=elystestnet-1 --broadcast-mode=block --yes --gas auto