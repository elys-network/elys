module github.com/elys-network/elys/simapp
...
require (
	...
	github.com/elys-network/elys v0.0.0-00010101000000-000000000000
...
replace (
	// use local elys-network/elys
	github.com/elys-network/elys => ../
