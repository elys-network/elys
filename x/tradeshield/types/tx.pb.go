...
type MsgCancelPerpetualOrders struct {
	OwnerAddress string                  `protobuf:"bytes,1,opt,name=owner_address,json=ownerAddress,proto3" json:"owner_address,omitempty"`
	Orders       []PerpetualOrderPoolKey `protobuf:"bytes,2,rep,name=orders,proto3" json:"orders"`
}
...
type MsgExecuteOrders struct {
	Creator         string              `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	PerpetualOrders []PerpetualOrderKey `protobuf:"bytes,2,rep,name=perpetual_orders,json=perpetualOrders,proto3" json:"perpetual_orders"`
...
var fileDescriptor_0534a5eaf85a8c0b = []byte{
	...
	0x22, 0x76, 0x97, 0x5d, 0x04, 0x95, 0xb6, 0x14, 0x9a, 0x00, 0x87, 0x08, 0x22, 0xa2, 0x85, 0x52,
	...
	,
}
