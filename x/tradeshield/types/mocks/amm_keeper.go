...
func (_m *AmmKeeper) CalcAmmPrice(ctx types.Context, denom string, decimal uint64) elystypes.Dec34 {
	...
	if rf, ok := ret.Get(0).(func(types.Context, string, uint64) elystypes.Dec34); ok {
...
func (_c *AmmKeeper_CalcAmmPrice_Call) Return(_a0 elystypes.Dec34) *AmmKeeper_CalcAmmPrice_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AmmKeeper_CalcAmmPrice_Call) RunAndReturn(run func(types.Context, string, uint64) elystypes.Dec34) *AmmKeeper_CalcAmmPrice_Call {
	_c.Call.Return(run)
	return _c
}

// CalculateUSDValue provides a mock function with given fields: ctx, denom, amount
func (_m *AmmKeeper) CalculateUSDValue(ctx types.Context, denom string, amount math.Int) elystypes.Dec34 {
	...
	var r0 elystypes.Dec34
	if rf, ok := ret.Get(0).(func(types.Context, string, math.Int) elystypes.Dec34); ok {
...
func (_c *AmmKeeper_CalculateUSDValue_Call) Return(_a0 elystypes.Dec34) *AmmKeeper_CalculateUSDValue_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AmmKeeper_CalculateUSDValue_Call) RunAndReturn(run func(types.Context, string, math.Int) elystypes.Dec34) *AmmKeeper_CalculateUSDValue_Call {
	_c.Call.Return(run)
	return _c
}
