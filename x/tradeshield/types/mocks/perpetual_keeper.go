...
// CheckIfWhitelisted provides a mock function with given fields: ctx, address
func (_m *PerpetualKeeper) CheckIfWhitelisted(ctx types.Context, address types.AccAddress) bool {
...
// PerpetualKeeper_CheckIfWhitelisted_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckIfWhitelisted'
type PerpetualKeeper_CheckIfWhitelisted_Call struct {
	*mock.Call
}
...
func (_e *PerpetualKeeper_Expecter) CheckIfWhitelisted(ctx interface{}, address interface{}) *PerpetualKeeper_CheckIfWhitelisted_Call {
	return &PerpetualKeeper_CheckIfWhitelisted_Call{Call: _e.mock.On("CheckIfWhitelisted", ctx, address)}
}

func (_c *PerpetualKeeper_CheckIfWhitelisted_Call) Run(run func(ctx types.Context, address types.AccAddress)) *PerpetualKeeper_CheckIfWhitelisted_Call {
...
func (_c *PerpetualKeeper_CheckIfWhitelisted_Call) Return(_a0 bool) *PerpetualKeeper_CheckIfWhitelisted_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PerpetualKeeper_CheckIfWhitelisted_Call) RunAndReturn(run func(types.Context, types.AccAddress) bool) *PerpetualKeeper_CheckIfWhitelisted_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetAllMTPForAddress provides a mock function with given fields: ctx, mtpAddress
func (_m *PerpetualKeeper) GetAllMTPForAddress(ctx types.Context, mtpAddress types.AccAddress) ([]*perpetualtypes.MtpAndPrice, error) {
	ret := _m.Called(ctx, mtpAddress)

	if len(ret) == 0 {
		panic("no return value specified for GetAllMTPForAddress")
	}

	var r0 []*perpetualtypes.MtpAndPrice
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, types.AccAddress) ([]*perpetualtypes.MtpAndPrice, error)); ok {
		return rf(ctx, mtpAddress)
	}
	if rf, ok := ret.Get(0).(func(types.Context, types.AccAddress) []*perpetualtypes.MtpAndPrice); ok {
		r0 = rf(ctx, mtpAddress)
	} else {
		if ret.Get(0) != nil {
...
// PerpetualKeeper_GetAllMTPForAddress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAllMTPForAddress'
type PerpetualKeeper_GetAllMTPForAddress_Call struct {
	*mock.Call
}

// GetAllMTPForAddress is a helper method to define mock.On call
//   - ctx types.Context
//   - mtpAddress types.AccAddress
func (_e *PerpetualKeeper_Expecter) GetAllMTPForAddress(ctx interface{}, mtpAddress interface{}) *PerpetualKeeper_GetAllMTPForAddress_Call {
	return &PerpetualKeeper_GetAllMTPForAddress_Call{Call: _e.mock.On("GetAllMTPForAddress", ctx, mtpAddress)}
}

func (_c *PerpetualKeeper_GetAllMTPForAddress_Call) Run(run func(ctx types.Context, mtpAddress types.AccAddress)) *PerpetualKeeper_GetAllMTPForAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context), args[1].(types.AccAddress))
	})
	return _c
...
func (_c *PerpetualKeeper_GetAllMTPForAddress_Call) Return(_a0 []*perpetualtypes.MtpAndPrice, _a1 error) *PerpetualKeeper_GetAllMTPForAddress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PerpetualKeeper_GetAllMTPForAddress_Call) RunAndReturn(run func(types.Context, types.AccAddress) ([]*perpetualtypes.MtpAndPrice, error)) *PerpetualKeeper_GetAllMTPForAddress_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetMTP provides a mock function with given fields: ctx, poolId, mtpAddress, id
func (_m *PerpetualKeeper) GetMTP(ctx types.Context, poolId uint64, mtpAddress types.AccAddress, id uint64) (perpetualtypes.MTP, error) {
	ret := _m.Called(ctx, poolId, mtpAddress, id)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, uint64, types.AccAddress, uint64) (perpetualtypes.MTP, error)); ok {
		return rf(ctx, poolId, mtpAddress, id)
	}
	if rf, ok := ret.Get(0).(func(types.Context, uint64, types.AccAddress, uint64) perpetualtypes.MTP); ok {
		r0 = rf(ctx, poolId, mtpAddress, id)
	} else {
		r0 = ret.Get(0).(perpetualtypes.MTP)
	}

	if rf, ok := ret.Get(1).(func(types.Context, uint64, types.AccAddress, uint64) error); ok {
		r1 = rf(ctx, poolId, mtpAddress, id)
	} else {
		r1 = ret.Error(1)
	}
...
//   - mtpAddress types.AccAddress
//   - id uint64
func (_e *PerpetualKeeper_Expecter) GetMTP(ctx interface{}, poolId interface{}, mtpAddress interface{}, id interface{}) *PerpetualKeeper_GetMTP_Call {
	return &PerpetualKeeper_GetMTP_Call{Call: _e.mock.On("GetMTP", ctx, poolId, mtpAddress, id)}
}

func (_c *PerpetualKeeper_GetMTP_Call) Run(run func(ctx types.Context, poolId uint64, mtpAddress types.AccAddress, id uint64)) *PerpetualKeeper_GetMTP_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context), args[1].(uint64), args[2].(types.AccAddress), args[3].(uint64))
	})
	return _c
}
...
func (_c *PerpetualKeeper_GetMTP_Call) RunAndReturn(run func(types.Context, uint64, types.AccAddress, uint64) (perpetualtypes.MTP, error)) *PerpetualKeeper_GetMTP_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *PerpetualKeeper) IsWhitelistingEnabled(ctx types.Context) bool {
	ret := _m.Called(ctx)
...
// PerpetualKeeper_IsWhitelistingEnabled_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsWhitelistingEnabled'
type PerpetualKeeper_IsWhitelistingEnabled_Call struct {
	*mock.Call
}

// IsWhitelistingEnabled is a helper method to define mock.On call
//   - ctx types.Context
func (_e *PerpetualKeeper_Expecter) IsWhitelistingEnabled(ctx interface{}) *PerpetualKeeper_IsWhitelistingEnabled_Call {
	return &PerpetualKeeper_IsWhitelistingEnabled_Call{Call: _e.mock.On("IsWhitelistingEnabled", ctx)}
}

func (_c *PerpetualKeeper_IsWhitelistingEnabled_Call) Run(run func(ctx types.Context)) *PerpetualKeeper_IsWhitelistingEnabled_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context))
	})
	return _c
...
func (_c *PerpetualKeeper_IsWhitelistingEnabled_Call) Return(_a0 bool) *PerpetualKeeper_IsWhitelistingEnabled_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PerpetualKeeper_IsWhitelistingEnabled_Call) RunAndReturn(run func(types.Context) bool) *PerpetualKeeper_IsWhitelistingEnabled_Call {
	_c.Call.Return(run)
	return _c
}
