...
func (_m *CloseLongChecker) EstimateAndRepay(ctx types.Context, mtp margintypes.MTP, pool margintypes.Pool, ammPool ammtypes.Pool, amount math.Int, baseCurrency string) (math.Int, error) {
...
func (_c *CloseLongChecker_EstimateAndRepay_Call) Run(run func(ctx types.Context, mtp margintypes.MTP, pool margintypes.Pool, ammPool ammtypes.Pool, amount math.Int, baseCurrency string)) *CloseLongChecker_EstimateAndRepay_Call {
...
func (_c *CloseLongChecker_EstimateAndRepay_Call) RunAndReturn(run func(types.Context, margintypes.MTP, margintypes.Pool, ammtypes.Pool, math.Int, string) (math.Int, error)) *CloseLongChecker_EstimateAndRepay_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CloseLongChecker) HandleBorrowInterest(ctx types.Context, mtp *margintypes.MTP, pool *margintypes.Pool, ammPool ammtypes.Pool) error {
...
func (_c *CloseLongChecker_HandleBorrowInterest_Call) Run(run func(ctx types.Context, mtp *margintypes.MTP, pool *margintypes.Pool, ammPool ammtypes.Pool)) *CloseLongChecker_HandleBorrowInterest_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CloseLongChecker_HandleBorrowInterest_Call) RunAndReturn(run func(types.Context, *margintypes.MTP, *margintypes.Pool, ammtypes.Pool) error) *CloseLongChecker_HandleBorrowInterest_Call {
	_c.Call.Return(run)
	return _c
}

// TakeOutCustody provides a mock function with given fields: ctx, mtp, pool, amount
func (_m *CloseLongChecker) TakeOutCustody(ctx types.Context, mtp margintypes.MTP, pool *margintypes.Pool, amount math.Int) error {
...
func (_c *CloseLongChecker_TakeOutCustody_Call) Run(run func(ctx types.Context, mtp margintypes.MTP, pool *margintypes.Pool, amount math.Int)) *CloseLongChecker_TakeOutCustody_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CloseLongChecker_TakeOutCustody_Call) RunAndReturn(run func(types.Context, margintypes.MTP, *margintypes.Pool, math.Int) error) *CloseLongChecker_TakeOutCustody_Call {
	_c.Call.Return(run)
	return _c
}
