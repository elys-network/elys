...
func (_m *OpenLongChecker) Borrow(ctx types.Context, collateralAmount math.Int, custodyAmount math.Int, mtp *margintypes.MTP, ammPool *ammtypes.Pool, pool *margintypes.Pool, eta math.LegacyDec, baseCurrency string) error {
...
func (_c *OpenLongChecker_Borrow_Call) Run(run func(ctx types.Context, collateralAmount math.Int, custodyAmount math.Int, mtp *margintypes.MTP, ammPool *ammtypes.Pool, pool *margintypes.Pool, eta math.LegacyDec, baseCurrency string)) *OpenLongChecker_Borrow_Call {
...
func (_c *OpenLongChecker_Borrow_Call) RunAndReturn(run func(types.Context, math.Int, math.Int, *margintypes.MTP, *ammtypes.Pool, *margintypes.Pool, math.LegacyDec, string) error) *OpenLongChecker_Borrow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OpenLongChecker) CheckMinLiabilities(ctx types.Context, collateralTokenAmt types.Coin, eta math.LegacyDec, pool margintypes.Pool, ammPool ammtypes.Pool, borrowAsset string, baseCurrency string) error {
...
//   - borrowAsset string
//   - baseCurrency string
func (_e *OpenLongChecker_Expecter) CheckMinLiabilities(ctx interface{}, collateralTokenAmt interface{}, eta interface{}, pool interface{}, ammPool interface{}, borrowAsset interface{}, baseCurrency interface{}) *OpenLongChecker_CheckMinLiabilities_Call {
	return &OpenLongChecker_CheckMinLiabilities_Call{Call: _e.mock.On("CheckMinLiabilities", ctx, collateralTokenAmt, eta, pool, ammPool, borrowAsset, baseCurrency)}
}

func (_c *OpenLongChecker_CheckMinLiabilities_Call) Run(run func(ctx types.Context, collateralTokenAmt types.Coin, eta math.LegacyDec, pool margintypes.Pool, ammPool ammtypes.Pool, borrowAsset string, baseCurrency string)) *OpenLongChecker_CheckMinLiabilities_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OpenLongChecker_CheckMinLiabilities_Call) RunAndReturn(run func(types.Context, types.Coin, math.LegacyDec, margintypes.Pool, ammtypes.Pool, string, string) error) *OpenLongChecker_CheckMinLiabilities_Call {
	_c.Call.Return(run)
	return _c
}
