...
func TestGetFirstValidPool_NoPoolID(t *testing.T) {
	...
	keeper := keeper.NewKeeper(nil, nil, nil, "cosmos1ysxv266l8w76lq0vy44ktzajdr9u9yhlxzlvga", mockAmm, nil)
	...
	_, err := keeper.GetFirstValidPool(ctx, borrowAsset)
...
func TestGetFirstValidPool_ValidPoolID(t *testing.T) {
	...
	poolID, err := keeper.GetFirstValidPool(ctx, borrowAsset)
