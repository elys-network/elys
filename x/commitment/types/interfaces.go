...
type CommitmentHooks interface {
	CommitmentChanged(ctx sdk.Context, creator sdk.AccAddress, amount sdk.Coins) error
	EdenUncommitted(ctx sdk.Context, creator sdk.AccAddress, amount sdk.Coin) error
