...
type MsgCommitLiquidTokens struct {
	...
	Amount  github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount"`
	Denom   string                                 `protobuf:"bytes,3,opt,name=denom,proto3" json:"denom,omitempty"`
	MinLock uint64                                 `protobuf:"varint,4,opt,name=min_lock,json=minLock,proto3" json:"min_lock,omitempty"`
}
...
var fileDescriptor_eda78aafe7eb119c = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// ClaimReward claim specific amount from unclaimed reward
	ClaimReward(ctx context.Context, in *MsgClaimReward, opts ...grpc.CallOption) (*MsgClaimRewardResponse, error)
	// ClaimRewards claim rewards from rewards-unclaimed and move to claimed state for Eden and send rewards to user's wallet
...
func (c *msgClient) ClaimReward(ctx context.Context, in *MsgClaimReward, opts ...grpc.CallOption) (*MsgClaimRewardResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/elys.commitment.Msg/ClaimReward", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ClaimReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/elys.commitment.Msg/ClaimReward",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
