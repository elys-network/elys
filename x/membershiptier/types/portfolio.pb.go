...
type Portfolio struct {
	...
	Coinvalue string `protobuf:"bytes,3,opt,name=coinvalue,proto3" json:"coinvalue,omitempty"`
...
func (m *Portfolio) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func (m *Portfolio) GetCoinvalue() string {
	if m != nil {
		return m.Coinvalue
	}
	return ""
...
var fileDescriptor_de2fe2eb41556835 = []byte{
	...
	,
}
...
func (m *Portfolio) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Coinvalue) > 0 {
		...
		i = encodeVarintPortfolio(dAtA, i, uint64(len(m.Coinvalue)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Assetkey) > 0 {
	...
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintPortfolio(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
