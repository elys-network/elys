...
func (suite *AmmKeeperTestSuite) TestSwapExactAmountOut() {
	for _, tc := range []struct {
		...
		},
		{
			...
			tokenIn:             sdk.NewInt64Coin("uusda", 10203),
			tokenInMax:          sdkmath.NewInt(10000000),
			tokenOut:            sdk.NewInt64Coin(ptypes.BaseCurrency, 10000),
			weightBalanceBonus:  sdkmath.LegacyZeroDec(),
			isOraclePool:        false,
			useNewRecipient:     false,
			expSenderBalance:    sdk.Coins{sdk.NewInt64Coin("uusda", 989797), sdk.NewInt64Coin(ptypes.BaseCurrency, 1010000)},
			expRecipientBalance: sdk.Coins{},
			expPoolBalance:      sdk.Coins{sdk.NewInt64Coin("uusda", 1010203), sdk.NewInt64Coin(ptypes.BaseCurrency, 989901)},
			expTreasuryBalance:  sdk.Coins{sdk.NewInt64Coin("uusda", 1000000), sdk.NewInt64Coin(ptypes.BaseCurrency, 1000000)},
			expPass:             true,
		},
		{
			...
			treasuryInitBalance: sdk.Coins{sdk.NewInt64Coin("uusda", 1000000), sdk.NewInt64Coin(ptypes.BaseCurrency, 1000000)},
			swapFeeOut:          sdkmath.LegacyZeroDec(),
			tokenIn:             sdk.NewInt64Coin("uusda", 10101),
			tokenInMax:          sdkmath.NewInt(10000000),
			tokenOut:            sdk.NewInt64Coin(ptypes.BaseCurrency, 10000),
			weightBalanceBonus:  sdkmath.LegacyZeroDec(),
			isOraclePool:        false,
			useNewRecipient:     false,
			expSenderBalance:    sdk.Coins{sdk.NewInt64Coin("uusda", 989899), sdk.NewInt64Coin(ptypes.BaseCurrency, 1010000)},
			expRecipientBalance: sdk.Coins{},
			expPoolBalance:      sdk.Coins{sdk.NewInt64Coin("uusda", 1010101), sdk.NewInt64Coin(ptypes.BaseCurrency, 990000)},
			expTreasuryBalance:  sdk.Coins{sdk.NewInt64Coin("uusda", 1000000), sdk.NewInt64Coin(ptypes.BaseCurrency, 1000000)},
			expPass:             true,
		},
		{
			...
			treasuryInitBalance: sdk.Coins{sdk.NewInt64Coin("uusda", 1000000), sdk.NewInt64Coin(ptypes.BaseCurrency, 1000000)},
			swapFeeOut:          sdkmath.LegacyZeroDec(),
			tokenIn:             sdk.NewInt64Coin("uusda", 222543),
			tokenInMax:          sdkmath.NewInt(10000000),
			tokenOut:            sdk.NewInt64Coin(ptypes.BaseCurrency, 200000),
			weightBalanceBonus:  sdkmath.LegacyZeroDec(),
			isOraclePool:        true,
			useNewRecipient:     false,
			expSenderBalance:    sdk.Coins{sdk.NewInt64Coin("uusda", 777457), sdk.NewInt64Coin(ptypes.BaseCurrency, 1200000)},
			expRecipientBalance: sdk.Coins{},
			expPoolBalance:      sdk.Coins{sdk.NewInt64Coin("uusda", 1222399), sdk.NewInt64Coin(ptypes.BaseCurrency, 800000)},
		...
		},
		{
			...
			expSenderBalance:    sdk.Coins{sdk.NewInt64Coin("uusda", 989899), sdk.NewInt64Coin(ptypes.BaseCurrency, 1000000)},
