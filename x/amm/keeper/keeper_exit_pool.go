...
func (k Keeper) ExitPool(
	...
	exitCoins, weightBalanceBonus, slippage, err = pool.ExitPool(ctx, k.oracleKeeper, k.accountedPoolKeeper, shareInAmount, tokenOutDenom, params, applyWeightBreakingFee)
	if err != nil {
