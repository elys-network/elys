...
func (k Keeper) ExitPoolEst(
	...
	exitCoins, weightBalanceBonus, slippage, swapFee, _, err = pool.CalcExitPoolCoinsFromShares(ctx, k.oracleKeeper, k.accountedPoolKeeper, shareInAmount, tokenOutDenom, params, true)
	if err != nil {
