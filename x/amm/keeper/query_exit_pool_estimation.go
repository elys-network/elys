...
func (k Keeper) ExitPoolEst(
	...
	exitCoins, weightBalanceBonus, slippage, swapFee, err = pool.CalcExitPoolCoinsFromShares(ctx, k.oracleKeeper, k.accountedPoolKeeper, shareInAmount, tokenOutDenom, params, takerFees, true)
	if err != nil {
