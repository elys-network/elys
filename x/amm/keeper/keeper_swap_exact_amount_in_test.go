...
func (suite *AmmKeeperTestSuite) TestSwapExactAmountIn() {
	for _, tc := range []struct {
		...
		},
		{
			...
			expRecipientBalance: sdk.Coins{},
			expPoolBalance:      sdk.Coins{sdk.NewInt64Coin("uusda", 1009998), sdk.NewInt64Coin(ptypes.BaseCurrency, 990056)},
			expTreasuryBalance:  sdk.Coins{sdk.NewInt64Coin("uusda", 1000002), sdk.NewInt64Coin(ptypes.BaseCurrency, 1000000)},
			expPass:             true,
			errMsg:              "",
		},
		{
