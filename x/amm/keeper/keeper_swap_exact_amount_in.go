...
func (k Keeper) InternalSwapExactAmountIn(
	...
	err = k.UpdatePoolForSwap(ctx, pool, sender, recipient, tokenIn, tokenOutCoin, swapFee, slippageAmount, math.ZeroInt(), oracleOutAmount.TruncateInt(), weightBalanceBonus, false)
	if err != nil {
		return math.Int{}, err
	}
