...
func (suite *AmmKeeperTestSuite) TestMsgServerExitPool() {
	for _, tc := range []struct {
		...
		},
		{
			...
			tokenOutDenom: "uusdt",
			minAmountsOut: sdk.Coins{sdk.NewInt64Coin("uusdt", 99950)},
			// expSenderBalance: sdk.Coins{sdk.NewInt64Coin("uusdt", 95114)}, // slippage enabled
			expSenderBalance: sdk.Coins{sdk.NewInt64Coin("uusdt", 99950)}, // slippage disabled
			expPass:          true,
		},
		{
			...
			minAmountsOut: sdk.Coins{sdk.NewInt64Coin(ptypes.BaseCurrency, 99220)},
			// expSenderBalance: sdk.Coins{sdk.NewInt64Coin(ptypes.BaseCurrency, 99197)}, // slippage enabled
			expSenderBalance: sdk.Coins{sdk.NewInt64Coin(ptypes.BaseCurrency, 99220)}, // slippage disabled
			expPass:          true,
		},
	} {
