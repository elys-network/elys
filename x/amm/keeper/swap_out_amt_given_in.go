...
func (k Keeper) SwapOutAmtGivenIn(
	...
	return ammPool.SwapOutAmtGivenIn(ctx, k.bankKeeper, recipient, oracleKeeper, snapshot, tokensIn, tokenOutDenom, swapFee, k.accountedPoolKeeper, weightBreakingFeePerpetualFactor, params, executeTransfer)
}
