...
func TestCalcSwapEstimationByDenom(t *testing.T) {
	...
	inRoute, outRoute, tokenOut, spotPrice, err := k.CalcSwapEstimationByDenom(ctx, amount, "denom1", "denom2", "baseCurrency")
	...
	_, _, _, _, err = k.CalcSwapEstimationByDenom(ctx, amount, "denom1", "denom2", "baseCurrency")
	require.Error(t, err)
}
