...
func EmitSwapPriceChangeEvent(ctx sdk.Context, tokenInDenom, tokenInPrice, tokenOutDenom, tokenOutPrice string) {
	ctx.EventManager().EmitEvents(sdk.Events{
		NewSwapPriceChangeEvent(tokenInDenom, tokenInPrice, tokenOutDenom, tokenOutPrice),
	})
}
...
func NewSwapPriceChangeEvent(tokenInDenom, tokenInPrice, tokenOutDenom, tokenOutPrice string) sdk.Event {
	return sdk.NewEvent(
