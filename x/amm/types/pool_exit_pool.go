...
func (p *Pool) ExitPool(ctx sdk.Context, oracleKeeper OracleKeeper, accountedPoolKeeper AccountedPoolKeeper, exitingShares math.Int, tokenOutDenom string, params Params, applyWeightBreakingFee bool) (exitingCoins sdk.Coins, weightBalanceBonus math.LegacyDec, swapFee math.LegacyDec, err error) {
	exitingCoins, weightBalanceBonus, swapFee, err = p.CalcExitPoolCoinsFromShares(ctx, oracleKeeper, accountedPoolKeeper, exitingShares, tokenOutDenom, params, applyWeightBreakingFee)
	if err != nil {
	...
	return exitingCoins, weightBalanceBonus, swapFee, nil
}
