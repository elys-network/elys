...
func (m *QueryMigrationReceipt) Reset()         { *m = QueryMigrationReceipt{} }
func (m *QueryMigrationReceipt) String() string { return proto.CompactTextString(m) }
func (*QueryMigrationReceipt) ProtoMessage()    {}
func (*QueryMigrationReceipt) Descriptor() ([]byte, []int) {
	return fileDescriptor_763da04a7298bbac, []int{33}
}
func (m *QueryMigrationReceipt) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryMigrationReceipt) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryMigrationReceipt.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryMigrationReceipt) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryMigrationReceipt.Merge(m, src)
}
func (m *QueryMigrationReceipt) XXX_Size() int {
	return m.Size()
}
func (m *QueryMigrationReceipt) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryMigrationReceipt.DiscardUnknown(m)
}

var xxx_messageInfo_QueryMigrationReceipt proto.InternalMessageInfo

func (m *QueryMigrationReceipt) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
type QueryMigrationReceiptResponse struct {
	Value BalanceMigrationReceipt `protobuf:"bytes,1,opt,name=value,proto3" json:"value"`
}

func (m *QueryMigrationReceiptResponse) Reset()         { *m = QueryMigrationReceiptResponse{} }
func (m *QueryMigrationReceiptResponse) String() string { return proto.CompactTextString(m) }
func (*QueryMigrationReceiptResponse) ProtoMessage()    {}
func (*QueryMigrationReceiptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_763da04a7298bbac, []int{34}
}
func (m *QueryMigrationReceiptResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryMigrationReceiptResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryMigrationReceiptResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryMigrationReceiptResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryMigrationReceiptResponse.Merge(m, src)
}
func (m *QueryMigrationReceiptResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryMigrationReceiptResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryMigrationReceiptResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryMigrationReceiptResponse proto.InternalMessageInfo

func (m *QueryMigrationReceiptResponse) GetValue() BalanceMigrationReceipt {
	if m != nil {
		return m.Value
	}
	return BalanceMigrationReceipt{}
}
...
func (m *QueryMigrationReceiptPaginated) Reset()         { *m = QueryMigrationReceiptPaginated{} }
func (m *QueryMigrationReceiptPaginated) String() string { return proto.CompactTextString(m) }
func (*QueryMigrationReceiptPaginated) ProtoMessage()    {}
func (*QueryMigrationReceiptPaginated) Descriptor() ([]byte, []int) {
	return fileDescriptor_763da04a7298bbac, []int{35}
}
func (m *QueryMigrationReceiptPaginated) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryMigrationReceiptPaginated) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryMigrationReceiptPaginated.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryMigrationReceiptPaginated) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryMigrationReceiptPaginated.Merge(m, src)
}
func (m *QueryMigrationReceiptPaginated) XXX_Size() int {
	return m.Size()
}
func (m *QueryMigrationReceiptPaginated) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryMigrationReceiptPaginated.DiscardUnknown(m)
}

var xxx_messageInfo_QueryMigrationReceiptPaginated proto.InternalMessageInfo

func (m *QueryMigrationReceiptPaginated) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryMigrationReceiptPaginatedResponse struct {
	List       []BalanceMigrationReceipt `protobuf:"bytes,1,rep,name=list,proto3" json:"list"`
	Pagination *query.PageResponse       `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryMigrationReceiptPaginatedResponse) Reset() {
	*m = QueryMigrationReceiptPaginatedResponse{}
}
func (m *QueryMigrationReceiptPaginatedResponse) String() string { return proto.CompactTextString(m) }
func (*QueryMigrationReceiptPaginatedResponse) ProtoMessage()    {}
func (*QueryMigrationReceiptPaginatedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_763da04a7298bbac, []int{36}
}
func (m *QueryMigrationReceiptPaginatedResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryMigrationReceiptPaginatedResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryMigrationReceiptPaginatedResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryMigrationReceiptPaginatedResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryMigrationReceiptPaginatedResponse.Merge(m, src)
}
func (m *QueryMigrationReceiptPaginatedResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryMigrationReceiptPaginatedResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryMigrationReceiptPaginatedResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryMigrationReceiptPaginatedResponse proto.InternalMessageInfo

func (m *QueryMigrationReceiptPaginatedResponse) GetList() []BalanceMigrationReceipt {
	if m != nil {
		return m.List
	}
	return nil
...
func (m *QueryMigrationReceiptPaginatedResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryMigrationReceipt)(nil), "elys.amm.QueryMigrationReceipt")
	proto.RegisterType((*QueryMigrationReceiptResponse)(nil), "elys.amm.QueryMigrationReceiptResponse")
	proto.RegisterType((*QueryMigrationReceiptPaginated)(nil), "elys.amm.QueryMigrationReceiptPaginated")
	proto.RegisterType((*QueryMigrationReceiptPaginatedResponse)(nil), "elys.amm.QueryMigrationReceiptPaginatedResponse")
}
...
var fileDescriptor_763da04a7298bbac = []byte{
	...
	,
}
...
func (*UnimplementedQueryServer) MigrationReceipt(ctx context.Context, req *QueryMigrationReceipt) (*QueryMigrationReceiptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MigrationReceipt not implemented")
}
func (*UnimplementedQueryServer) MigrationReceiptPaginated(ctx context.Context, req *QueryMigrationReceiptPaginated) (*QueryMigrationReceiptPaginatedResponse, error) {
...
func (m *QueryMigrationReceipt) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryMigrationReceipt) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryMigrationReceipt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryMigrationReceiptResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryMigrationReceiptResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryMigrationReceiptResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryMigrationReceiptPaginated) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryMigrationReceiptPaginated) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryMigrationReceiptPaginated) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryMigrationReceiptPaginatedResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryMigrationReceiptPaginatedResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryMigrationReceiptPaginatedResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryMigrationReceipt) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryMigrationReceiptResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryMigrationReceiptPaginated) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryMigrationReceiptPaginatedResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryMigrationReceipt) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryMigrationReceipt: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryMigrationReceipt: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryMigrationReceiptResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryMigrationReceiptResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryMigrationReceiptResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryMigrationReceiptPaginated) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryMigrationReceiptPaginated: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryMigrationReceiptPaginated: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryMigrationReceiptPaginatedResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryMigrationReceiptPaginatedResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryMigrationReceiptPaginatedResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.List = append(m.List, BalanceMigrationReceipt{})
