...
type MsgCreatPerpetualMarket struct {
	...
	MinPriceTickSize        cosmossdk_io_math.Dec `protobuf:"bytes,9,opt,name=min_price_tick_size,json=minPriceTickSize,proto3,customtype=cosmossdk.io/math.Dec" json:"min_price_tick_size"`
	...
	MinNotional       cosmossdk_io_math.Dec `protobuf:"bytes,11,opt,name=min_notional,json=minNotional,proto3,customtype=cosmossdk.io/math.Dec" json:"min_notional"`
...
type MsgPlaceLimitOrder struct {
	...
	BaseQuantity cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=base_quantity,json=baseQuantity,proto3,customtype=cosmossdk.io/math.Int" json:"base_quantity"`
...
type MsgPlaceMarketOrder struct {
	Creator      string                `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	MarketId     uint64                `protobuf:"varint,2,opt,name=market_id,json=marketId,proto3" json:"market_id,omitempty"`
	BaseQuantity cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=base_quantity,json=baseQuantity,proto3,customtype=cosmossdk.io/math.Int" json:"base_quantity"`
...
var fileDescriptor_0f29ee2c2ad74792 = []byte{
	...
	,
}
