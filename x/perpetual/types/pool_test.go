...
func TestPool_UpdateLiabilitiesValid(t *testing.T) {
	...
	pool := types.NewPool(ammPool, math.LegacyMustNewDecFromStr("11.5"), math.LegacyMustNewDecFromStr("1.025000000000000000"))
...
func TestKeeper_GetPerpetualPoolBalances(t *testing.T) {
	...
	perpetualPool := types.NewPool(ammPool, math.LegacyMustNewDecFromStr("11.5"), math.LegacyMustNewDecFromStr("1.025000000000000000"))
	...
	liabilities, custody := perpetualPool.GetPerpetualPoolBalances("testAsset")
