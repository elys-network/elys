...
func (_c *CloseShortChecker_GetMTP_Call) Run(run func(ctx types.Context, mtpAddress types.AccAddress, id uint64)) *CloseShortChecker_GetMTP_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CloseShortChecker_GetMTP_Call) RunAndReturn(run func(types.Context, types.AccAddress, uint64) (perpetualtypes.MTP, error)) *CloseShortChecker_GetMTP_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *CloseShortChecker_SettleBorrowInterest_Call) Return(_a0 math.Int, _a1 error) *CloseShortChecker_SettleBorrowInterest_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CloseShortChecker_SettleBorrowInterest_Call) RunAndReturn(run func(types.Context, *perpetualtypes.MTP, *perpetualtypes.Pool, ammtypes.Pool) (math.Int, error)) *CloseShortChecker_SettleBorrowInterest_Call {
	_c.Call.Return(run)
	return _c
}
