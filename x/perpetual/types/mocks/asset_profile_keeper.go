...
// GetUsdcDenom provides a mock function with given fields: ctx
func (_m *AssetProfileKeeper) GetUsdcDenom(ctx types.Context) (string, bool) {
	ret := _m.Called(ctx)
...
// AssetProfileKeeper_GetUsdcDenom_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUsdcDenom'
type AssetProfileKeeper_GetUsdcDenom_Call struct {
	*mock.Call
}

// GetUsdcDenom is a helper method to define mock.On call
//   - ctx types.Context
func (_e *AssetProfileKeeper_Expecter) GetUsdcDenom(ctx interface{}) *AssetProfileKeeper_GetUsdcDenom_Call {
	return &AssetProfileKeeper_GetUsdcDenom_Call{Call: _e.mock.On("GetUsdcDenom", ctx)}
}

func (_c *AssetProfileKeeper_GetUsdcDenom_Call) Run(run func(ctx types.Context)) *AssetProfileKeeper_GetUsdcDenom_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *AssetProfileKeeper_GetUsdcDenom_Call) Return(usdcDenom string, found bool) *AssetProfileKeeper_GetUsdcDenom_Call {
	_c.Call.Return(usdcDenom, found)
	return _c
}

func (_c *AssetProfileKeeper_GetUsdcDenom_Call) RunAndReturn(run func(types.Context) (string, bool)) *AssetProfileKeeper_GetUsdcDenom_Call {
	_c.Call.Return(run)
	return _c
}
