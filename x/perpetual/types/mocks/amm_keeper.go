...
func (_m *AmmKeeper) CalcSwapEstimationByDenom(ctx types.Context, amount types.Coin, denomIn string, denomOut string, baseCurrency string, discount types.Dec, overrideSwapFee types.Dec, decimals uint64) ([]*ammtypes.SwapAmountInRoute, []*ammtypes.SwapAmountOutRoute, types.Coin, types.Dec, types.Dec, types.Dec, types.Coin, types.Dec, types.Dec, types.Dec, error) {
	ret := _m.Called(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)

	if len(ret) == 0 {
		panic("no return value specified for CalcSwapEstimationByDenom")
	}
	...
	var r9 types.Dec
	var r10 error
	if rf, ok := ret.Get(0).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) ([]*ammtypes.SwapAmountInRoute, []*ammtypes.SwapAmountOutRoute, types.Coin, types.Dec, types.Dec, types.Dec, types.Coin, types.Dec, types.Dec, types.Dec, error)); ok {
		return rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	}
	if rf, ok := ret.Get(0).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) []*ammtypes.SwapAmountInRoute); ok {
	...
	if rf, ok := ret.Get(1).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) []*ammtypes.SwapAmountOutRoute); ok {
	...
	if rf, ok := ret.Get(2).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Coin); ok {
		r2 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r2 = ret.Get(2).(types.Coin)
	}

	if rf, ok := ret.Get(3).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Dec); ok {
		r3 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r3 = ret.Get(3).(types.Dec)
	}

	if rf, ok := ret.Get(4).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Dec); ok {
		r4 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r4 = ret.Get(4).(types.Dec)
	}

	if rf, ok := ret.Get(5).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Dec); ok {
		r5 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r5 = ret.Get(5).(types.Dec)
	}

	if rf, ok := ret.Get(6).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Coin); ok {
		r6 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r6 = ret.Get(6).(types.Coin)
	}

	if rf, ok := ret.Get(7).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Dec); ok {
		r7 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r7 = ret.Get(7).(types.Dec)
	}

	if rf, ok := ret.Get(8).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Dec); ok {
		r8 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r8 = ret.Get(8).(types.Dec)
	}

	if rf, ok := ret.Get(9).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) types.Dec); ok {
		r9 = rf(ctx, amount, denomIn, denomOut, baseCurrency, discount, overrideSwapFee, decimals)
	} else {
		r9 = ret.Get(9).(types.Dec)
	}

	if rf, ok := ret.Get(10).(func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) error); ok {
...
func (_c *AmmKeeper_CalcSwapEstimationByDenom_Call) Run(run func(ctx types.Context, amount types.Coin, denomIn string, denomOut string, baseCurrency string, discount types.Dec, overrideSwapFee types.Dec, decimals uint64)) *AmmKeeper_CalcSwapEstimationByDenom_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context), args[1].(types.Coin), args[2].(string), args[3].(string), args[4].(string), args[5].(types.Dec), args[6].(types.Dec), args[7].(uint64))
	})
	return _c
}

func (_c *AmmKeeper_CalcSwapEstimationByDenom_Call) Return(inRoute []*ammtypes.SwapAmountInRoute, outRoute []*ammtypes.SwapAmountOutRoute, outAmount types.Coin, spotPrice types.Dec, swapFee types.Dec, discountOut types.Dec, availableLiquidity types.Coin, slippage types.Dec, weightBonus types.Dec, priceImpact types.Dec, err error) *AmmKeeper_CalcSwapEstimationByDenom_Call {
...
func (_c *AmmKeeper_CalcSwapEstimationByDenom_Call) RunAndReturn(run func(types.Context, types.Coin, string, string, string, types.Dec, types.Dec, uint64) ([]*ammtypes.SwapAmountInRoute, []*ammtypes.SwapAmountOutRoute, types.Coin, types.Dec, types.Dec, types.Dec, types.Coin, types.Dec, types.Dec, types.Dec, error)) *AmmKeeper_CalcSwapEstimationByDenom_Call {
	_c.Call.Return(run)
	return _c
}
