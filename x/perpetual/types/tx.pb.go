...
type PoolParams struct {
	...
	MtpSafetyFactor cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=mtp_safety_factor,json=mtpSafetyFactor,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"mtp_safety_factor"`
	LeverageMax     cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=leverage_max,json=leverageMax,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"leverage_max"`
}
...
func (m *PoolParams) GetPoolId() uint64 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
type MsgUpdateEnabledPools struct {
	...
	UpdatePoolParams []PoolParams `protobuf:"bytes,5,rep,name=update_pool_params,json=updatePoolParams,proto3" json:"update_pool_params"`
}
...
func (m *MsgUpdateEnabledPools) GetUpdatePoolParams() []PoolParams {
	if m != nil {
		return m.UpdatePoolParams
	}
	return nil
}
...
func (*MsgAddCollateralResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5e879ed5011cdd71, []int{22}
}
...
func init() {
	...
	proto.RegisterType((*PoolParams)(nil), "elys.perpetual.PoolParams")
...
var fileDescriptor_5e879ed5011cdd71 = []byte{
	...
	,
}
...
func (m *MsgUpdateEnabledPools) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UpdatePoolParams) > 0 {
		for iNdEx := len(m.UpdatePoolParams) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UpdatePoolParams[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgUpdateEnabledPools) Size() (n int) {
	...
	if len(m.UpdatePoolParams) > 0 {
		for _, e := range m.UpdatePoolParams {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgUpdateEnabledPools) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdatePoolParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UpdatePoolParams = append(m.UpdatePoolParams, PoolParams{})
			if err := m.UpdatePoolParams[len(m.UpdatePoolParams)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
