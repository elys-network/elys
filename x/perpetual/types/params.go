...
func (p Params) Validate() error {
	...
	if err := CheckLegacyDecNilAndNegative(p.SecondLiquidationTriggerRatio, "SecondLiquidationTriggerRatio"); err != nil {
		return err
	}
	if p.SecondLiquidationTriggerRatio.GTE(math.LegacyOneDec()) {
		return errors.New("SecondLiquidationTriggerRatio must be less than 1")
	}
