...
var (
	...
	ErrMTPDisabled            = sdkerrors.Register(ModuleName, 3, "perpetual not enabled for pool")
	...
	ErrPerpetualDisabled      = sdkerrors.Register(ModuleName, 33, "perpetual disabled pool")
