...
func (m *QueryInvariantCustodyLiabRequest) Reset()         { *m = QueryInvariantCustodyLiabRequest{} }
func (m *QueryInvariantCustodyLiabRequest) String() string { return proto.CompactTextString(m) }
func (*QueryInvariantCustodyLiabRequest) ProtoMessage()    {}
func (*QueryInvariantCustodyLiabRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a2c961615c1b7fe, []int{29}
}
func (m *QueryInvariantCustodyLiabRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryInvariantCustodyLiabRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryInvariantCustodyLiabRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryInvariantCustodyLiabRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryInvariantCustodyLiabRequest.Merge(m, src)
}
func (m *QueryInvariantCustodyLiabRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryInvariantCustodyLiabRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryInvariantCustodyLiabRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryInvariantCustodyLiabRequest proto.InternalMessageInfo

func (m *QueryInvariantCustodyLiabRequest) GetPoolId() uint64 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
func (m *QueryInvariantCustodyLiabRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryInvariantCustodyLiabResponse struct {
	TotalCustody                []types.Coin `protobuf:"bytes,1,rep,name=total_custody,json=totalCustody,proto3" json:"total_custody"`
	TotalLiabilities            []types.Coin `protobuf:"bytes,2,rep,name=total_liabilities,json=totalLiabilities,proto3" json:"total_liabilities"`
	TotalCustodyWithoutLazy     []types.Coin `protobuf:"bytes,3,rep,name=total_custody_without_lazy,json=totalCustodyWithoutLazy,proto3" json:"total_custody_without_lazy"`
	TotalLiabilitiesWithoutLazy []types.Coin `protobuf:"bytes,4,rep,name=total_liabilities_without_lazy,json=totalLiabilitiesWithoutLazy,proto3" json:"total_liabilities_without_lazy"`
	PoolCustody                 []types.Coin `protobuf:"bytes,5,rep,name=pool_custody,json=poolCustody,proto3" json:"pool_custody"`
	PoolLiabilities             []types.Coin `protobuf:"bytes,6,rep,name=pool_liabilities,json=poolLiabilities,proto3" json:"pool_liabilities"`
}

func (m *QueryInvariantCustodyLiabResponse) Reset()         { *m = QueryInvariantCustodyLiabResponse{} }
func (m *QueryInvariantCustodyLiabResponse) String() string { return proto.CompactTextString(m) }
func (*QueryInvariantCustodyLiabResponse) ProtoMessage()    {}
func (*QueryInvariantCustodyLiabResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a2c961615c1b7fe, []int{30}
}
func (m *QueryInvariantCustodyLiabResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryInvariantCustodyLiabResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryInvariantCustodyLiabResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryInvariantCustodyLiabResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryInvariantCustodyLiabResponse.Merge(m, src)
}
func (m *QueryInvariantCustodyLiabResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryInvariantCustodyLiabResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryInvariantCustodyLiabResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryInvariantCustodyLiabResponse proto.InternalMessageInfo

func (m *QueryInvariantCustodyLiabResponse) GetTotalCustody() []types.Coin {
	if m != nil {
		return m.TotalCustody
	}
	return nil
}

func (m *QueryInvariantCustodyLiabResponse) GetTotalLiabilities() []types.Coin {
	if m != nil {
		return m.TotalLiabilities
	}
	return nil
...
func (m *QueryInvariantCustodyLiabResponse) GetTotalCustodyWithoutLazy() []types.Coin {
	if m != nil {
		return m.TotalCustodyWithoutLazy
	}
	return nil
}

func (m *QueryInvariantCustodyLiabResponse) GetTotalLiabilitiesWithoutLazy() []types.Coin {
	if m != nil {
		return m.TotalLiabilitiesWithoutLazy
	}
	return nil
}

func (m *QueryInvariantCustodyLiabResponse) GetPoolCustody() []types.Coin {
	if m != nil {
		return m.PoolCustody
	}
	return nil
}

func (m *QueryInvariantCustodyLiabResponse) GetPoolLiabilities() []types.Coin {
	if m != nil {
		return m.PoolLiabilities
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*QueryInvariantCustodyLiabRequest)(nil), "elys.perpetual.QueryInvariantCustodyLiabRequest")
	proto.RegisterType((*QueryInvariantCustodyLiabResponse)(nil), "elys.perpetual.QueryInvariantCustodyLiabResponse")
}
...
var fileDescriptor_9a2c961615c1b7fe = []byte{
	...
	,
}
...
func (*UnimplementedQueryServer) InvariantCustodyLiab(ctx context.Context, req *QueryInvariantCustodyLiabRequest) (*QueryInvariantCustodyLiabResponse, error) {
...
func (m *QueryInvariantCustodyLiabRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryInvariantCustodyLiabRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryInvariantCustodyLiabRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryInvariantCustodyLiabResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryInvariantCustodyLiabResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryInvariantCustodyLiabResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.PoolLiabilities) > 0 {
		for iNdEx := len(m.PoolLiabilities) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PoolLiabilities[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.PoolCustody) > 0 {
		for iNdEx := len(m.PoolCustody) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PoolCustody[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.TotalLiabilitiesWithoutLazy) > 0 {
		for iNdEx := len(m.TotalLiabilitiesWithoutLazy) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TotalLiabilitiesWithoutLazy[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.TotalCustodyWithoutLazy) > 0 {
		for iNdEx := len(m.TotalCustodyWithoutLazy) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TotalCustodyWithoutLazy[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.TotalCustody) > 0 {
		for iNdEx := len(m.TotalCustody) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TotalCustody[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryInvariantCustodyLiabRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryInvariantCustodyLiabResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.TotalCustodyWithoutLazy) > 0 {
		for _, e := range m.TotalCustodyWithoutLazy {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
	if len(m.TotalLiabilitiesWithoutLazy) > 0 {
		for _, e := range m.TotalLiabilitiesWithoutLazy {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
	if len(m.PoolCustody) > 0 {
		for _, e := range m.PoolCustody {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
	if len(m.PoolLiabilities) > 0 {
		for _, e := range m.PoolLiabilities {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryInvariantCustodyLiabRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryInvariantCustodyLiabRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryInvariantCustodyLiabRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryInvariantCustodyLiabResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryInvariantCustodyLiabResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryInvariantCustodyLiabResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalCustody", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalCustody = append(m.TotalCustody, types.Coin{})
			if err := m.TotalCustody[len(m.TotalCustody)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalCustodyWithoutLazy", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalCustodyWithoutLazy = append(m.TotalCustodyWithoutLazy, types.Coin{})
			if err := m.TotalCustodyWithoutLazy[len(m.TotalCustodyWithoutLazy)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalLiabilitiesWithoutLazy", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalLiabilitiesWithoutLazy = append(m.TotalLiabilitiesWithoutLazy, types.Coin{})
			if err := m.TotalLiabilitiesWithoutLazy[len(m.TotalLiabilitiesWithoutLazy)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PoolCustody", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PoolCustody = append(m.PoolCustody, types.Coin{})
			if err := m.PoolCustody[len(m.PoolCustody)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PoolLiabilities", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PoolLiabilities = append(m.PoolLiabilities, types.Coin{})
			if err := m.PoolLiabilities[len(m.PoolLiabilities)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
