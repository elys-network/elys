...
func (k Keeper) EmitClose(ctx sdk.Context, trigger string, closedMtp types.MTP, repayAmount math.Int, closingRatio math.LegacyDec, returnAmt, fundingFeeAmt, fundingAmtDistributed, interestAmt, insuranceAmt math.Int, allInterestsPaid, forceClosed bool, totalPerpetualFeesCoins types.PerpetualFees, closingPrice math.LegacyDec, initialCollateral sdk.Coin, initialCustody, initialLiabilities math.Int) error {
