...
func TestOpenLong_ErrorsDuringOperations(t *testing.T) {
	...
	mtp := types.NewMTP(msg.Creator, msg.Collateral.Denom, msg.TradingAsset, msg.Collateral.Denom, msg.TradingAsset, msg.Position, msg.Leverage, types.TakeProfitPriceDefault, ammPool.PoolId)
