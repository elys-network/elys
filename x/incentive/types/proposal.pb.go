...
func (m *PoolMultipliers) GetMultiplier() uint64 {
	if m != nil {
		return m.Multiplier
	}
	return 0
...
var fileDescriptor_ccb8f1511f38d9ad = []byte{
	...
	,
	...
	0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x20, 0xb3, 0x75, 0xa1, 0x16, 0x81, 0x39, 0xfa, 0x15, 0x48, 0xd1,
	0x50, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x0e, 0x52, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x76, 0x7b, 0x7d, 0xd2, 0xa5, 0x01, 0x00, 0x00,
}
...
func (m *PoolMultipliers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Multiplier != 0 {
		i = encodeVarintProposal(dAtA, i, uint64(m.Multiplier))
		i--
		dAtA[i] = 0x10
	}
	if m.PoolId != 0 {
...
func (m *PoolMultipliers) Size() (n int) {
	...
	if m.Multiplier != 0 {
		n += 1 + sovProposal(uint64(m.Multiplier))
	}
	return n
}
