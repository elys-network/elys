...
var pricesMap = map[string]math.LegacyDec{
	...
	"BLD":   math.LegacyMustNewDecFromStr("0.01081"),
	"AXL":   math.LegacyMustNewDecFromStr("0.1995"),
	"STARS": math.LegacyMustNewDecFromStr("0.0003856"),
	"STRD":  math.LegacyMustNewDecFromStr("0.06384"),
}
