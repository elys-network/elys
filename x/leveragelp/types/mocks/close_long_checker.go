...
func (_m *CloseLongChecker) EstimateAndRepay(ctx types.Context, mtp leveragelptypes.MTP, pool leveragelptypes.Pool, ammPool ammtypes.Pool, collateralAsset string, custodyAsset string) (math.Int, error) {
...
func (_c *CloseLongChecker_EstimateAndRepay_Call) Run(run func(ctx types.Context, mtp leveragelptypes.MTP, pool leveragelptypes.Pool, ammPool ammtypes.Pool, collateralAsset string, custodyAsset string)) *CloseLongChecker_EstimateAndRepay_Call {
...
func (_c *CloseLongChecker_EstimateAndRepay_Call) RunAndReturn(run func(types.Context, leveragelptypes.MTP, leveragelptypes.Pool, ammtypes.Pool, string, string) (math.Int, error)) *CloseLongChecker_EstimateAndRepay_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CloseLongChecker) GetMTP(ctx types.Context, mtpAddress string, id uint64) (leveragelptypes.MTP, error) {
...
func (_c *CloseLongChecker_GetMTP_Call) Return(_a0 leveragelptypes.MTP, _a1 error) *CloseLongChecker_GetMTP_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CloseLongChecker_GetMTP_Call) RunAndReturn(run func(types.Context, string, uint64) (leveragelptypes.MTP, error)) *CloseLongChecker_GetMTP_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CloseLongChecker) HandleInterest(ctx types.Context, mtp *leveragelptypes.MTP, pool *leveragelptypes.Pool, ammPool ammtypes.Pool, collateralAsset string, custodyAsset string) error {
	ret := _m.Called(ctx, mtp, pool, ammPool, collateralAsset, custodyAsset)
...
func (_c *CloseLongChecker_HandleInterest_Call) Run(run func(ctx types.Context, mtp *leveragelptypes.MTP, pool *leveragelptypes.Pool, ammPool ammtypes.Pool, collateralAsset string, custodyAsset string)) *CloseLongChecker_HandleInterest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context), args[1].(*leveragelptypes.MTP), args[2].(*leveragelptypes.Pool), args[3].(ammtypes.Pool), args[4].(string), args[5].(string))
	})
	return _c
...
func (_c *CloseLongChecker_HandleInterest_Call) RunAndReturn(run func(types.Context, *leveragelptypes.MTP, *leveragelptypes.Pool, ammtypes.Pool, string, string) error) *CloseLongChecker_HandleInterest_Call {
	_c.Call.Return(run)
	return _c
}
