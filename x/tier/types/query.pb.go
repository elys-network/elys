...
type QueryGetConsolidatedPriceResponse struct {
	AmmPrice       cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=ammPrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"ammPrice"`
	OraclePrice    cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=oraclePrice,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"oraclePrice"`
	OraclePriceDec cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=oraclePriceDec,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"oraclePriceDec"`
}
...
type QueryStakedResponse struct {
	...
	TotalVested cosmossdk_io_math.LegacyDec `protobuf:"bytes,4,opt,name=totalVested,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"totalVested"`
}
...
var fileDescriptor_461504ebf74c9a97 = []byte{
	...
	,
}
