...
type QueryLeverageLpTotalResponse struct {
	TotalValue   github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=total_value,json=totalValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"total_value"`
	TotalBorrows github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=total_borrows,json=totalBorrows,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"total_borrows"`
}
...
type QueryGetConsolidatedPriceResponse struct {
	AmmPrice       github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=amm_price,json=ammPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"amm_price"`
	OraclePrice    github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=oracle_price,json=oraclePrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"oracle_price"`
	OraclePriceDec github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=oracle_price_dec,json=oraclePriceDec,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"oracle_price_dec"`
}
...
type QueryStakedResponse struct {
	...
	TotalVested github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=total_vested,json=totalVested,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"total_vested"`
}
...
var fileDescriptor_461504ebf74c9a97 = []byte{
	...
	,
}
