...
type MsgToggleTakerFeeSwapAndBurnResponse struct {
	BurntCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=burnt_coins,json=burntCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"burnt_coins"`
}
...
func (m *MsgToggleTakerFeeSwapAndBurnResponse) GetBurntCoins() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.BurntCoins
	}
	return nil
...
var fileDescriptor_2574ed545e5b2c11 = []byte{
	...
	,
}
...
func (m *MsgToggleTakerFeeSwapAndBurnResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BurntCoins) > 0 {
		for iNdEx := len(m.BurntCoins) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BurntCoins[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *MsgToggleTakerFeeSwapAndBurnResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BurntCoins", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BurntCoins = append(m.BurntCoins, types.Coin{})
			if err := m.BurntCoins[len(m.BurntCoins)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
