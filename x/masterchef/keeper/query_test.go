...
func (suite *MasterchefKeeperTestSuite) TestApr() {
	tests := []struct {
	...
	}{
		{
			...
			response: &types.QueryAprResponse{
				Apr: elystypes.NewDec34FromString("0.3").String(),
			},
			err: nil,
		},
		{
	...
	tests := []struct {
	...
	}{
		{
			...
			response: &types.QueryAprsResponse{
				...
				EdenAprEdenb: elystypes.NewDec34FromString("0.3").String(),
				UsdcAprEden:  elystypes.ZeroDec34().String(),
				EdenAprEden:  elystypes.NewDec34FromString("0.3").String(),
				EdenbAprEden: elystypes.OneDec34().String(),
				UsdcAprElys:  elystypes.ZeroDec34().String(),
				EdenAprElys:  elystypes.NewDec34FromString("0.3").String(),
