...
var _ protoreflect.List = (*_AccountedPool_5_list)(nil)

type _AccountedPool_5_list struct {
	list *[]*v1beta1.Coin
}

func (x *_AccountedPool_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_AccountedPool_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_AccountedPool_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_AccountedPool_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_AccountedPool_5_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_AccountedPool_5_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_AccountedPool_5_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_AccountedPool_5_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_AccountedPool_total_shares        protoreflect.FieldDescriptor
	fd_AccountedPool_pool_assets         protoreflect.FieldDescriptor
	fd_AccountedPool_total_weight        protoreflect.FieldDescriptor
...
func init() {
	...
	fd_AccountedPool_total_shares = md_AccountedPool.Fields().ByName("total_shares")
	fd_AccountedPool_pool_assets = md_AccountedPool.Fields().ByName("pool_assets")
	fd_AccountedPool_total_weight = md_AccountedPool.Fields().ByName("total_weight")
...
func (x *fastReflection_AccountedPool) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TotalShares != nil {
		...
		if !f(fd_AccountedPool_total_shares, value) {
			return
		}
	}
	if len(x.PoolAssets) != 0 {
		value := protoreflect.ValueOfList(&_AccountedPool_3_list{list: &x.PoolAssets})
		if !f(fd_AccountedPool_pool_assets, value) {
			return
		}
	}
	if x.TotalWeight != "" {
		value := protoreflect.ValueOfString(x.TotalWeight)
		if !f(fd_AccountedPool_total_weight, value) {
			return
		}
	}
	if len(x.NonAmmPoolTokens) != 0 {
		value := protoreflect.ValueOfList(&_AccountedPool_5_list{list: &x.NonAmmPoolTokens})
...
func (x *fastReflection_AccountedPool) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.accountedpool.AccountedPool.total_shares":
		return x.TotalShares != nil
	case "elys.accountedpool.AccountedPool.pool_assets":
		return len(x.PoolAssets) != 0
	case "elys.accountedpool.AccountedPool.total_weight":
...
func (x *fastReflection_AccountedPool) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.accountedpool.AccountedPool.pool_assets":
		...
		listValue := &_AccountedPool_3_list{list: &x.PoolAssets}
	...
	case "elys.accountedpool.AccountedPool.non_amm_pool_tokens":
		if len(x.NonAmmPoolTokens) == 0 {
			return protoreflect.ValueOfList(&_AccountedPool_5_list{})
		}
		listValue := &_AccountedPool_5_list{list: &x.NonAmmPoolTokens}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_AccountedPool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.accountedpool.AccountedPool.pool_assets":
		...
		value := &_AccountedPool_3_list{list: &x.PoolAssets}
		return protoreflect.ValueOfList(value)
	case "elys.accountedpool.AccountedPool.non_amm_pool_tokens":
		if x.NonAmmPoolTokens == nil {
			x.NonAmmPoolTokens = []*v1beta1.Coin{}
		}
		value := &_AccountedPool_5_list{list: &x.NonAmmPoolTokens}
		return protoreflect.ValueOfList(value)
	case "elys.accountedpool.AccountedPool.pool_id":
		panic(fmt.Errorf("field pool_id of message elys.accountedpool.AccountedPool is not mutable"))
	case "elys.accountedpool.AccountedPool.total_weight":
		panic(fmt.Errorf("field total_weight of message elys.accountedpool.AccountedPool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.accountedpool.AccountedPool"))
		}
...
func (x *fastReflection_AccountedPool) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.accountedpool.AccountedPool.non_amm_pool_tokens":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_AccountedPool_5_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.accountedpool.AccountedPool"))
		}
...
func (x *AccountedPool) GetTotalShares() *v1beta1.Coin {
	if x != nil {
...
func (x *AccountedPool) GetPoolAssets() []*amm.PoolAsset {
	if x != nil {
		return x.PoolAssets
	}
	return nil
...
func (x *AccountedPool) GetTotalWeight() string {
	if x != nil {
		return x.TotalWeight
	}
	return ""
...
var file_elys_accountedpool_accounted_pool_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc8, 0x02, 0x0a, 0x0d, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x64, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x17, 0x0a, 0x07, 0x70,
	0x6f, 0x6f, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x70, 0x6f,
	0x6f, 0x6c, 0x49, 0x64, 0x12, 0x42, 0x0a, 0x0c, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x68,
	0x61, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73,
	...
	0x5f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	...
	0x69, 0x67, 0x68, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2b, 0xc8, 0xde, 0x1f, 0x00,
	...
	,
...
var file_elys_accountedpool_accounted_pool_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_elys_accountedpool_accounted_pool_proto_goTypes = []interface{}{
	(*AccountedPool)(nil), // 0: elys.accountedpool.AccountedPool
	(*v1beta1.Coin)(nil),  // 1: cosmos.base.v1beta1.Coin
	(*amm.PoolAsset)(nil), // 2: elys.amm.PoolAsset
}
var file_elys_accountedpool_accounted_pool_proto_depIdxs = []int32{
	1, // 0: elys.accountedpool.AccountedPool.total_shares:type_name -> cosmos.base.v1beta1.Coin
	2, // 1: elys.accountedpool.AccountedPool.pool_assets:type_name -> elys.amm.PoolAsset
	1, // 2: elys.accountedpool.AccountedPool.non_amm_pool_tokens:type_name -> cosmos.base.v1beta1.Coin
