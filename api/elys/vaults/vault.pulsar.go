...
var _ protoreflect.List = (*_Vault_18_list)(nil)

type _Vault_18_list struct {
	list *[]string
}

func (x *_Vault_18_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Vault_18_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_Vault_18_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_Vault_18_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_Vault_18_list) AppendMutable() protoreflect.Value {
...
func (x *_Vault_18_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_Vault_18_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Vault_18_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_Vault_description                protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Vault_description = md_Vault.Fields().ByName("description")
...
func (x *fastReflection_Vault) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SumOfDepositsUsdValue != "" {
		value := protoreflect.ValueOfString(x.SumOfDepositsUsdValue)
		if !f(fd_Vault_sum_of_deposits_usd_value, value) {
			return
		}
	}
	if x.WithdrawalUsdValue != "" {
		value := protoreflect.ValueOfString(x.WithdrawalUsdValue)
		if !f(fd_Vault_withdrawal_usd_value, value) {
			return
		}
	}
	if x.Address != "" {
	...
	if x.Description != "" {
		...
		if !f(fd_Vault_description, value) {
			return
		}
	}
	if len(x.AllowedActions) != 0 {
		value := protoreflect.ValueOfList(&_Vault_18_list{list: &x.AllowedActions})
...
func (x *fastReflection_Vault) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.vaults.Vault.sum_of_deposits_usd_value":
		return x.SumOfDepositsUsdValue != ""
	...
	case "elys.vaults.Vault.description":
...
func (x *fastReflection_Vault) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.vaults.Vault.lockup_period":
		...
		return protoreflect.ValueOfUint64(value)
	case "elys.vaults.Vault.sum_of_deposits_usd_value":
		value := x.SumOfDepositsUsdValue
		return protoreflect.ValueOfString(value)
	case "elys.vaults.Vault.withdrawal_usd_value":
		value := x.WithdrawalUsdValue
		return protoreflect.ValueOfString(value)
	case "elys.vaults.Vault.address":
		value := x.Address
		return protoreflect.ValueOfString(value)
	...
	case "elys.vaults.Vault.allowed_actions":
		if len(x.AllowedActions) == 0 {
			return protoreflect.ValueOfList(&_Vault_18_list{})
		}
		listValue := &_Vault_18_list{list: &x.AllowedActions}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_Vault) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "elys.vaults.Vault.sum_of_deposits_usd_value":
		x.SumOfDepositsUsdValue = value.Interface().(string)
	case "elys.vaults.Vault.withdrawal_usd_value":
...
func (x *fastReflection_Vault) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.vaults.Vault.allowed_actions":
		...
		value := &_Vault_18_list{list: &x.AllowedActions}
		return protoreflect.ValueOfList(value)
	case "elys.vaults.Vault.deposit_denom":
	...
	case "elys.vaults.Vault.sum_of_deposits_usd_value":
		panic(fmt.Errorf("field sum_of_deposits_usd_value of message elys.vaults.Vault is not mutable"))
	case "elys.vaults.Vault.withdrawal_usd_value":
	...
	case "elys.vaults.Vault.description":
		panic(fmt.Errorf("field description of message elys.vaults.Vault is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.vaults.Vault"))
		}
...
func (x *fastReflection_Vault) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.vaults.Vault.allowed_actions":
		list := []string{}
		return protoreflect.ValueOfList(&_Vault_18_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.vaults.Vault"))
		}
...
func (x *fastReflection_Vault) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.SumOfDepositsUsdValue)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.WithdrawalUsdValue)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.Address)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.WithdrawalUsdValue) > 0 {
			i -= len(x.WithdrawalUsdValue)
			copy(dAtA[i:], x.WithdrawalUsdValue)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.WithdrawalUsdValue)))
			i--
			dAtA[i] = 0x6a
		}
		if len(x.SumOfDepositsUsdValue) > 0 {
			i -= len(x.SumOfDepositsUsdValue)
			copy(dAtA[i:], x.SumOfDepositsUsdValue)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.SumOfDepositsUsdValue)))
			i--
			dAtA[i] = 0x62
		}
		if x.LockupPeriod != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 12:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SumOfDepositsUsdValue", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.SumOfDepositsUsdValue = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 13:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field WithdrawalUsdValue", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.WithdrawalUsdValue = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 14:
				if wireType != 2 {
...
var (
	...
	fd_UserData_total_deposits_usd    protoreflect.FieldDescriptor
	fd_UserData_total_withdrawals_usd protoreflect.FieldDescriptor
	fd_UserData_eden_usd_value        protoreflect.FieldDescriptor
	fd_UserData_eden_amount           protoreflect.FieldDescriptor
)

func init() {
	file_elys_vaults_vault_proto_init()
	md_UserData = File_elys_vaults_vault_proto.Messages().ByName("UserData")
	fd_UserData_total_deposits_usd = md_UserData.Fields().ByName("total_deposits_usd")
	fd_UserData_total_withdrawals_usd = md_UserData.Fields().ByName("total_withdrawals_usd")
	fd_UserData_eden_usd_value = md_UserData.Fields().ByName("eden_usd_value")
	fd_UserData_eden_amount = md_UserData.Fields().ByName("eden_amount")
}
...
func (x *fastReflection_UserData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TotalDepositsUsd != "" {
		...
		if !f(fd_UserData_total_deposits_usd, value) {
			return
		}
	}
	if x.TotalWithdrawalsUsd != "" {
		value := protoreflect.ValueOfString(x.TotalWithdrawalsUsd)
		if !f(fd_UserData_total_withdrawals_usd, value) {
			return
		}
	}
	if x.EdenUsdValue != "" {
		value := protoreflect.ValueOfString(x.EdenUsdValue)
		if !f(fd_UserData_eden_usd_value, value) {
			return
		}
	}
	if x.EdenAmount != "" {
		value := protoreflect.ValueOfString(x.EdenAmount)
		if !f(fd_UserData_eden_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_UserData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.vaults.UserData.total_deposits_usd":
		return x.TotalDepositsUsd != ""
	case "elys.vaults.UserData.total_withdrawals_usd":
		return x.TotalWithdrawalsUsd != ""
	case "elys.vaults.UserData.eden_usd_value":
		return x.EdenUsdValue != ""
	case "elys.vaults.UserData.eden_amount":
		return x.EdenAmount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.vaults.UserData"))
		}
		panic(fmt.Errorf("message elys.vaults.UserData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_UserData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message elys.vaults.UserData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_UserData) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "elys.vaults.UserData.total_withdrawals_usd":
		x.TotalWithdrawalsUsd = value.Interface().(string)
	case "elys.vaults.UserData.eden_usd_value":
...
func (x *fastReflection_UserData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.vaults.UserData.total_deposits_usd":
		panic(fmt.Errorf("field total_deposits_usd of message elys.vaults.UserData is not mutable"))
	case "elys.vaults.UserData.total_withdrawals_usd":
		panic(fmt.Errorf("field total_withdrawals_usd of message elys.vaults.UserData is not mutable"))
	case "elys.vaults.UserData.eden_usd_value":
		panic(fmt.Errorf("field eden_usd_value of message elys.vaults.UserData is not mutable"))
	case "elys.vaults.UserData.eden_amount":
		panic(fmt.Errorf("field eden_amount of message elys.vaults.UserData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.vaults.UserData"))
		}
...
func (x *fastReflection_UserData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.vaults.UserData", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_UserData) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TotalWithdrawalsUsd) > 0 {
			i -= len(x.TotalWithdrawalsUsd)
			copy(dAtA[i:], x.TotalWithdrawalsUsd)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalWithdrawalsUsd)))
			i--
			dAtA[i] = 0x12
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalWithdrawalsUsd", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalWithdrawalsUsd = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
...
var (
	md_VaultPnL          protoreflect.MessageDescriptor
	fd_VaultPnL_vault_id protoreflect.FieldDescriptor
	fd_VaultPnL_pnl_usd  protoreflect.FieldDescriptor
	fd_VaultPnL_date     protoreflect.FieldDescriptor
)

func init() {
	file_elys_vaults_vault_proto_init()
	md_VaultPnL = File_elys_vaults_vault_proto.Messages().ByName("VaultPnL")
	fd_VaultPnL_vault_id = md_VaultPnL.Fields().ByName("vault_id")
	fd_VaultPnL_pnl_usd = md_VaultPnL.Fields().ByName("pnl_usd")
	fd_VaultPnL_date = md_VaultPnL.Fields().ByName("date")
}

var _ protoreflect.Message = (*fastReflection_VaultPnL)(nil)

type fastReflection_VaultPnL VaultPnL

func (x *VaultPnL) ProtoReflect() protoreflect.Message {
	return (*fastReflection_VaultPnL)(x)
}

func (x *VaultPnL) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_vaults_vault_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_VaultPnL_messageType fastReflection_VaultPnL_messageType
var _ protoreflect.MessageType = fastReflection_VaultPnL_messageType{}

type fastReflection_VaultPnL_messageType struct{}

func (x fastReflection_VaultPnL_messageType) Zero() protoreflect.Message {
	return (*fastReflection_VaultPnL)(nil)
}
func (x fastReflection_VaultPnL_messageType) New() protoreflect.Message {
	return new(fastReflection_VaultPnL)
}
func (x fastReflection_VaultPnL_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_VaultPnL
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_VaultPnL) Descriptor() protoreflect.MessageDescriptor {
	return md_VaultPnL
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_VaultPnL) Type() protoreflect.MessageType {
	return _fastReflection_VaultPnL_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_VaultPnL) New() protoreflect.Message {
	return new(fastReflection_VaultPnL)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_VaultPnL) Interface() protoreflect.ProtoMessage {
	return (*VaultPnL)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_VaultPnL) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.VaultId != "" {
		value := protoreflect.ValueOfString(x.VaultId)
		if !f(fd_VaultPnL_vault_id, value) {
			return
		}
	}
	if x.PnlUsd != "" {
		value := protoreflect.ValueOfString(x.PnlUsd)
		if !f(fd_VaultPnL_pnl_usd, value) {
			return
		}
	}
	if x.Date != "" {
		value := protoreflect.ValueOfString(x.Date)
		if !f(fd_VaultPnL_date, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_VaultPnL) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.vaults.VaultPnL.vault_id":
		return x.VaultId != ""
	case "elys.vaults.VaultPnL.pnl_usd":
		return x.PnlUsd != ""
	case "elys.vaults.VaultPnL.date":
		return x.Date != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.vaults.VaultPnL"))
		}
		panic(fmt.Errorf("message elys.vaults.VaultPnL does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_VaultPnL) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.vaults.VaultPnL.vault_id":
		x.VaultId = ""
	case "elys.vaults.VaultPnL.pnl_usd":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_VaultPnL) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.vaults.VaultPnL.vault_id":
		value := x.VaultId
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message elys.vaults.VaultPnL does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_VaultPnL) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.vaults.VaultPnL.vault_id":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_VaultPnL) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.vaults.VaultPnL.vault_id":
		panic(fmt.Errorf("field vault_id of message elys.vaults.VaultPnL is not mutable"))
	case "elys.vaults.VaultPnL.pnl_usd":
		panic(fmt.Errorf("field pnl_usd of message elys.vaults.VaultPnL is not mutable"))
	case "elys.vaults.VaultPnL.date":
		panic(fmt.Errorf("field date of message elys.vaults.VaultPnL is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.vaults.VaultPnL"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_VaultPnL) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.vaults.VaultPnL.vault_id":
		return protoreflect.ValueOfString("")
	case "elys.vaults.VaultPnL.pnl_usd":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_VaultPnL) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.vaults.VaultPnL", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_VaultPnL) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_VaultPnL) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_VaultPnL) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_VaultPnL) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*VaultPnL)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: VaultPnL: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: VaultPnL: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *Vault) GetSumOfDepositsUsdValue() string {
	if x != nil {
		return x.SumOfDepositsUsdValue
	}
	return ""
...
func (x *Vault) GetWithdrawalUsdValue() string {
	if x != nil {
		return x.WithdrawalUsdValue
	}
	return ""
...
func (x *Vault) GetAllowedActions() []string {
	if x != nil {
...
type UserData struct {
	...
	TotalDepositsUsd    string `protobuf:"bytes,1,opt,name=total_deposits_usd,json=totalDepositsUsd,proto3" json:"total_deposits_usd,omitempty"`
	TotalWithdrawalsUsd string `protobuf:"bytes,2,opt,name=total_withdrawals_usd,json=totalWithdrawalsUsd,proto3" json:"total_withdrawals_usd,omitempty"`
	EdenUsdValue        string `protobuf:"bytes,3,opt,name=eden_usd_value,json=edenUsdValue,proto3" json:"eden_usd_value,omitempty"`
	EdenAmount          string `protobuf:"bytes,4,opt,name=eden_amount,json=edenAmount,proto3" json:"eden_amount,omitempty"`
}
...
func (x *UserData) GetTotalDepositsUsd() string {
	if x != nil {
		return x.TotalDepositsUsd
	}
	return ""
...
func (x *UserData) GetTotalWithdrawalsUsd() string {
	if x != nil {
		return x.TotalWithdrawalsUsd
	}
	return ""
...
func (x *UserData) GetEdenUsdValue() string {
	if x != nil {
		return x.EdenUsdValue
	}
	return ""
...
func (x *UserData) GetEdenAmount() string {
	if x != nil {
		return x.EdenAmount
	}
	return ""
...
type VaultPnL struct {
	...
	PnlUsd  string `protobuf:"bytes,2,opt,name=pnl_usd,json=pnlUsd,proto3" json:"pnl_usd,omitempty"`
	Date    string `protobuf:"bytes,3,opt,name=date,proto3" json:"date,omitempty"`
}

func (x *VaultPnL) Reset() {
	*x = VaultPnL{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_vaults_vault_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *VaultPnL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultPnL) ProtoMessage() {}

// Deprecated: Use VaultPnL.ProtoReflect.Descriptor instead.
func (*VaultPnL) Descriptor() ([]byte, []int) {
	return file_elys_vaults_vault_proto_rawDescGZIP(), []int{2}
}

func (x *VaultPnL) GetVaultId() string {
	if x != nil {
		return x.VaultId
	}
	return ""
...
func (x *VaultPnL) GetPnlUsd() string {
	if x != nil {
		return x.PnlUsd
	}
	return ""
...
func (x *VaultPnL) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
var file_elys_vaults_vault_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x73, 0x2f, 0x74, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa5, 0x09,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x6c, 0x6f, 0x63, 0x6b, 0x75, 0x70, 0x50, 0x65,
	0x72, 0x69, 0x6f, 0x64, 0x12, 0x6b, 0x0a, 0x19, 0x73, 0x75, 0x6d, 0x5f, 0x6f, 0x66, 0x5f, 0x64,
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x73, 0x5f, 0x75, 0x73, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75,
	...
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x15, 0x73, 0x75, 0x6d, 0x4f,
	0x66, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x73, 0x55, 0x73, 0x64, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x12, 0x63, 0x0a, 0x14, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x5f,
	0x75, 0x73, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x42,
	...
	0x65, 0x63, 0x52, 0x12, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x55, 0x73,
	...
	0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x46, 0x65, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65,
	...
	0x12, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xf9, 0x02, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61,
	0x74, 0x61, 0x12, 0x5f, 0x0a, 0x12, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x64, 0x65, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x73, 0x5f, 0x75, 0x73, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31,
	...
	0x63, 0x52, 0x10, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x73,
	0x55, 0x73, 0x64, 0x12, 0x65, 0x0a, 0x15, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x77, 0x69, 0x74,
	0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x73, 0x5f, 0x75, 0x73, 0x64, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x2f, 0x65, 0x6c, 0x79, 0x73, 0x2f, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x73, 0xa2, 0x02, 0x03, 0x45,
	0x56, 0x58, 0xaa, 0x02, 0x0b, 0x45, 0x6c, 0x79, 0x73, 0x2e, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x73,
	0xca, 0x02, 0x0b, 0x45, 0x6c, 0x79, 0x73, 0x5c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x73, 0xe2, 0x02,
	0x17, 0x45, 0x6c, 0x79, 0x73, 0x5c, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x5c, 0x47, 0x50, 0x42,
...
var file_elys_vaults_vault_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_elys_vaults_vault_proto_goTypes = []interface{}{
	(*Vault)(nil),    // 0: elys.vaults.Vault
	(*UserData)(nil), // 1: elys.vaults.UserData
	(*VaultPnL)(nil), // 2: elys.vaults.VaultPnL
}
...
func file_elys_vaults_vault_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_elys_vaults_vault_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VaultPnL); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
