...
var (
	md_LegacyTimeBasedInflation                    protoreflect.MessageDescriptor
	fd_LegacyTimeBasedInflation_start_block_height protoreflect.FieldDescriptor
	fd_LegacyTimeBasedInflation_end_block_height   protoreflect.FieldDescriptor
	fd_LegacyTimeBasedInflation_description        protoreflect.FieldDescriptor
	fd_LegacyTimeBasedInflation_inflation          protoreflect.FieldDescriptor
	fd_LegacyTimeBasedInflation_authority          protoreflect.FieldDescriptor
)

func init() {
	file_elys_tokenomics_time_based_inflation_proto_init()
	md_LegacyTimeBasedInflation = File_elys_tokenomics_time_based_inflation_proto.Messages().ByName("LegacyTimeBasedInflation")
	fd_LegacyTimeBasedInflation_start_block_height = md_LegacyTimeBasedInflation.Fields().ByName("start_block_height")
	fd_LegacyTimeBasedInflation_end_block_height = md_LegacyTimeBasedInflation.Fields().ByName("end_block_height")
	fd_LegacyTimeBasedInflation_description = md_LegacyTimeBasedInflation.Fields().ByName("description")
	fd_LegacyTimeBasedInflation_inflation = md_LegacyTimeBasedInflation.Fields().ByName("inflation")
	fd_LegacyTimeBasedInflation_authority = md_LegacyTimeBasedInflation.Fields().ByName("authority")
}

var _ protoreflect.Message = (*fastReflection_LegacyTimeBasedInflation)(nil)

type fastReflection_LegacyTimeBasedInflation LegacyTimeBasedInflation

func (x *LegacyTimeBasedInflation) ProtoReflect() protoreflect.Message {
	return (*fastReflection_LegacyTimeBasedInflation)(x)
}

func (x *LegacyTimeBasedInflation) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_tokenomics_time_based_inflation_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_LegacyTimeBasedInflation_messageType fastReflection_LegacyTimeBasedInflation_messageType
var _ protoreflect.MessageType = fastReflection_LegacyTimeBasedInflation_messageType{}

type fastReflection_LegacyTimeBasedInflation_messageType struct{}

func (x fastReflection_LegacyTimeBasedInflation_messageType) Zero() protoreflect.Message {
	return (*fastReflection_LegacyTimeBasedInflation)(nil)
}
func (x fastReflection_LegacyTimeBasedInflation_messageType) New() protoreflect.Message {
	return new(fastReflection_LegacyTimeBasedInflation)
}
func (x fastReflection_LegacyTimeBasedInflation_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_LegacyTimeBasedInflation
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_LegacyTimeBasedInflation) Descriptor() protoreflect.MessageDescriptor {
	return md_LegacyTimeBasedInflation
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_LegacyTimeBasedInflation) Type() protoreflect.MessageType {
	return _fastReflection_LegacyTimeBasedInflation_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_LegacyTimeBasedInflation) New() protoreflect.Message {
	return new(fastReflection_LegacyTimeBasedInflation)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_LegacyTimeBasedInflation) Interface() protoreflect.ProtoMessage {
	return (*LegacyTimeBasedInflation)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_LegacyTimeBasedInflation) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.StartBlockHeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.StartBlockHeight)
		if !f(fd_LegacyTimeBasedInflation_start_block_height, value) {
			return
		}
	}
	if x.EndBlockHeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.EndBlockHeight)
		if !f(fd_LegacyTimeBasedInflation_end_block_height, value) {
			return
		}
	}
	if x.Description != "" {
		value := protoreflect.ValueOfString(x.Description)
		if !f(fd_LegacyTimeBasedInflation_description, value) {
			return
		}
	}
	if x.Inflation != nil {
		value := protoreflect.ValueOfMessage(x.Inflation.ProtoReflect())
		if !f(fd_LegacyTimeBasedInflation_inflation, value) {
			return
		}
	}
	if x.Authority != "" {
		value := protoreflect.ValueOfString(x.Authority)
		if !f(fd_LegacyTimeBasedInflation_authority, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_LegacyTimeBasedInflation) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.tokenomics.LegacyTimeBasedInflation.start_block_height":
		return x.StartBlockHeight != uint64(0)
	case "elys.tokenomics.LegacyTimeBasedInflation.end_block_height":
		return x.EndBlockHeight != uint64(0)
	case "elys.tokenomics.LegacyTimeBasedInflation.description":
		return x.Description != ""
	case "elys.tokenomics.LegacyTimeBasedInflation.inflation":
		return x.Inflation != nil
	case "elys.tokenomics.LegacyTimeBasedInflation.authority":
		return x.Authority != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.tokenomics.LegacyTimeBasedInflation"))
		}
		panic(fmt.Errorf("message elys.tokenomics.LegacyTimeBasedInflation does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LegacyTimeBasedInflation) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.tokenomics.LegacyTimeBasedInflation.start_block_height":
		x.StartBlockHeight = uint64(0)
	case "elys.tokenomics.LegacyTimeBasedInflation.end_block_height":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_LegacyTimeBasedInflation) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.tokenomics.LegacyTimeBasedInflation.start_block_height":
		value := x.StartBlockHeight
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message elys.tokenomics.LegacyTimeBasedInflation does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LegacyTimeBasedInflation) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.tokenomics.LegacyTimeBasedInflation.start_block_height":
		x.StartBlockHeight = value.Uint()
	case "elys.tokenomics.LegacyTimeBasedInflation.end_block_height":
	...
	case "elys.tokenomics.LegacyTimeBasedInflation.description":
		x.Description = value.Interface().(string)
	case "elys.tokenomics.LegacyTimeBasedInflation.inflation":
		x.Inflation = value.Message().Interface().(*LegacyInflationEntry)
	case "elys.tokenomics.LegacyTimeBasedInflation.authority":
		x.Authority = value.Interface().(string)
	default:
		if fd.IsExtension() {
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LegacyTimeBasedInflation) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.tokenomics.LegacyTimeBasedInflation.inflation":
		if x.Inflation == nil {
			x.Inflation = new(LegacyInflationEntry)
		}
		return protoreflect.ValueOfMessage(x.Inflation.ProtoReflect())
	case "elys.tokenomics.LegacyTimeBasedInflation.start_block_height":
		panic(fmt.Errorf("field start_block_height of message elys.tokenomics.LegacyTimeBasedInflation is not mutable"))
	case "elys.tokenomics.LegacyTimeBasedInflation.end_block_height":
		panic(fmt.Errorf("field end_block_height of message elys.tokenomics.LegacyTimeBasedInflation is not mutable"))
	case "elys.tokenomics.LegacyTimeBasedInflation.description":
		panic(fmt.Errorf("field description of message elys.tokenomics.LegacyTimeBasedInflation is not mutable"))
	case "elys.tokenomics.LegacyTimeBasedInflation.authority":
		panic(fmt.Errorf("field authority of message elys.tokenomics.LegacyTimeBasedInflation is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.tokenomics.LegacyTimeBasedInflation"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_LegacyTimeBasedInflation) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.tokenomics.LegacyTimeBasedInflation.start_block_height":
		return protoreflect.ValueOfUint64(uint64(0))
	case "elys.tokenomics.LegacyTimeBasedInflation.end_block_height":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_LegacyTimeBasedInflation) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.tokenomics.LegacyTimeBasedInflation", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_LegacyTimeBasedInflation) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_LegacyTimeBasedInflation) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_LegacyTimeBasedInflation) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_LegacyTimeBasedInflation) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*LegacyTimeBasedInflation)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: LegacyTimeBasedInflation: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: LegacyTimeBasedInflation: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
			...
			case 4:
				...
				if x.Inflation == nil {
					x.Inflation = &LegacyInflationEntry{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Inflation); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
...
func (x *LegacyTimeBasedInflation) Reset() {
	*x = LegacyTimeBasedInflation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_tokenomics_time_based_inflation_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *LegacyTimeBasedInflation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LegacyTimeBasedInflation) ProtoMessage() {}

// Deprecated: Use LegacyTimeBasedInflation.ProtoReflect.Descriptor instead.
func (*LegacyTimeBasedInflation) Descriptor() ([]byte, []int) {
	return file_elys_tokenomics_time_based_inflation_proto_rawDescGZIP(), []int{1}
}

func (x *LegacyTimeBasedInflation) GetStartBlockHeight() uint64 {
	if x != nil {
		return x.StartBlockHeight
	}
	return 0
...
func (x *LegacyTimeBasedInflation) GetEndBlockHeight() uint64 {
	if x != nil {
		return x.EndBlockHeight
	}
	return 0
...
func (x *LegacyTimeBasedInflation) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *LegacyTimeBasedInflation) GetInflation() *LegacyInflationEntry {
	if x != nil {
		return x.Inflation
	}
	return nil
...
func (x *LegacyTimeBasedInflation) GetAuthority() string {
	if x != nil {
		return x.Authority
	}
	return ""
...
var file_elys_tokenomics_time_based_inflation_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x22, 0xf7, 0x01, 0x0a, 0x18, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x54, 0x69, 0x6d,
	0x65, 0x42, 0x61, 0x73, 0x65, 0x64, 0x49, 0x6e, 0x66, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x2c, 0x0a, 0x12, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x68,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x73, 0x74, 0x61,
	...
	,
...
var file_elys_tokenomics_time_based_inflation_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_elys_tokenomics_time_based_inflation_proto_goTypes = []interface{}{
	...
	(*LegacyTimeBasedInflation)(nil), // 1: elys.tokenomics.LegacyTimeBasedInflation
	(*InflationEntry)(nil),           // 2: elys.tokenomics.InflationEntry
	(*LegacyInflationEntry)(nil),     // 3: elys.tokenomics.LegacyInflationEntry
}
var file_elys_tokenomics_time_based_inflation_proto_depIdxs = []int32{
	2, // 0: elys.tokenomics.TimeBasedInflation.inflation:type_name -> elys.tokenomics.InflationEntry
	3, // 1: elys.tokenomics.LegacyTimeBasedInflation.inflation:type_name -> elys.tokenomics.LegacyInflationEntry
...
func file_elys_tokenomics_time_based_inflation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_elys_tokenomics_time_based_inflation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LegacyTimeBasedInflation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
