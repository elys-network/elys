...
const (
	Query_Params_FullMethodName                   = "/elys.leveragelp.Query/Params"
	Query_QueryPositions_FullMethodName           = "/elys.leveragelp.Query/QueryPositions"
	Query_QueryPositionsByPool_FullMethodName     = "/elys.leveragelp.Query/QueryPositionsByPool"
	Query_GetStatus_FullMethodName                = "/elys.leveragelp.Query/GetStatus"
	Query_QueryPositionsForAddress_FullMethodName = "/elys.leveragelp.Query/QueryPositionsForAddress"
	Query_GetWhitelist_FullMethodName             = "/elys.leveragelp.Query/GetWhitelist"
	Query_IsWhitelisted_FullMethodName            = "/elys.leveragelp.Query/IsWhitelisted"
	Query_Pool_FullMethodName                     = "/elys.leveragelp.Query/Pool"
	Query_Pools_FullMethodName                    = "/elys.leveragelp.Query/Pools"
	Query_Position_FullMethodName                 = "/elys.leveragelp.Query/Position"
	Query_LiquidationPrice_FullMethodName         = "/elys.leveragelp.Query/LiquidationPrice"
	Query_OpenEst_FullMethodName                  = "/elys.leveragelp.Query/OpenEst"
	Query_CloseEst_FullMethodName                 = "/elys.leveragelp.Query/CloseEst"
	Query_Rewards_FullMethodName                  = "/elys.leveragelp.Query/Rewards"
	Query_CommittedTokensLocked_FullMethodName    = "/elys.leveragelp.Query/CommittedTokensLocked"
)
...
func (c *queryClient) QueryPositionsByPool(ctx context.Context, in *PositionsByPoolRequest, opts ...grpc.CallOption) (*PositionsByPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QueryPositionsByPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryPositionsForAddress(ctx context.Context, in *PositionsForAddressRequest, opts ...grpc.CallOption) (*PositionsForAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QueryPositionsForAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) OpenEst(ctx context.Context, in *QueryOpenEstRequest, opts ...grpc.CallOption) (*QueryOpenEstResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_OpenEst_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CloseEst(ctx context.Context, in *QueryCloseEstRequest, opts ...grpc.CallOption) (*QueryCloseEstResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_CloseEst_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CommittedTokensLocked(ctx context.Context, in *QueryCommittedTokensLockedRequest, opts ...grpc.CallOption) (*QueryCommittedTokensLockedResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_CommittedTokensLocked_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QueryPositionsByPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_QueryPositionsByPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_QueryPositionsForAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_QueryPositionsForAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_OpenEst_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_OpenEst_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CloseEst_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_CloseEst_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CommittedTokensLocked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_CommittedTokensLocked_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
