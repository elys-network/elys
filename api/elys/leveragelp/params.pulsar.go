...
var (
	...
	fd_Params_exit_fee             protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_exit_fee = md_Params.Fields().ByName("exit_fee")
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.leveragelp.Params.exit_fee":
		return x.ExitFee != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.leveragelp.Params.exit_fee":
		panic(fmt.Errorf("field exit_fee of message elys.leveragelp.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.leveragelp.Params"))
		}
...
type Params struct {
	...
	ExitFee             string   `protobuf:"bytes,10,opt,name=exit_fee,json=exitFee,proto3" json:"exit_fee,omitempty"`
}
...
func (x *Params) GetExitFee() string {
	if x != nil {
		return x.ExitFee
	}
	return ""
...
var file_elys_leveragelp_params_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x50, 0x65, 0x72, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xe5, 0x04, 0x0a, 0x06,
	...
	,
