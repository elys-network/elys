...
const (
	Query_Params_FullMethodName    = "/elys.estaking.Query/Params"
	Query_Rewards_FullMethodName   = "/elys.estaking.Query/Rewards"
	Query_Invariant_FullMethodName = "/elys.estaking.Query/Invariant"
)
