...
const (
	Msg_UpdateParams_FullMethodName               = "/elys.estaking.Msg/UpdateParams"
	Msg_WithdrawReward_FullMethodName             = "/elys.estaking.Msg/WithdrawReward"
	Msg_WithdrawElysStakingRewards_FullMethodName = "/elys.estaking.Msg/WithdrawElysStakingRewards"
	Msg_WithdrawAllRewards_FullMethodName         = "/elys.estaking.Msg/WithdrawAllRewards"
)
...
func (c *msgClient) WithdrawElysStakingRewards(ctx context.Context, in *MsgWithdrawElysStakingRewards, opts ...grpc.CallOption) (*MsgWithdrawElysStakingRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_WithdrawElysStakingRewards_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawAllRewards(ctx context.Context, in *MsgWithdrawAllRewards, opts ...grpc.CallOption) (*MsgWithdrawAllRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_WithdrawAllRewards_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_WithdrawElysStakingRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_WithdrawElysStakingRewards_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawAllRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_WithdrawAllRewards_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
