...
var file_elys_estaking_params_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12,
...
var file_elys_estaking_params_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_elys_estaking_params_proto_goTypes = []interface{}{
	(*Params)(nil),            // 0: elys.estaking.Params
	(*IncentiveInfo)(nil),     // 1: elys.estaking.IncentiveInfo
	(*DexRewardsTracker)(nil), // 2: elys.estaking.DexRewardsTracker
}
var file_elys_estaking_params_proto_depIdxs = []int32{
	1, // 0: elys.estaking.Params.stake_incentives:type_name -> elys.estaking.IncentiveInfo
	2, // 1: elys.estaking.Params.dex_rewards_stakers:type_name -> elys.estaking.DexRewardsTracker
