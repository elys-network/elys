...
func (x *fastReflection_PerpetualOrder) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SubAccountId != uint64(0) {
		...
		if !f(fd_PerpetualOrder_sub_account_id, value) {
			return
		}
	}
	if x.Amount != "" {
...
func (x *fastReflection_PerpetualOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.clob.PerpetualOrder.sub_account_id":
		panic(fmt.Errorf("field sub_account_id of message elys.clob.PerpetualOrder is not mutable"))
	case "elys.clob.PerpetualOrder.amount":
...
var (
	...
	fd_OrderKey_price      protoreflect.FieldDescriptor
...
func init() {
	...
	fd_OrderKey_price = md_OrderKey.Fields().ByName("price")
...
func (x *fastReflection_OrderKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.clob.OrderKey.price":
		panic(fmt.Errorf("field price of message elys.clob.OrderKey is not mutable"))
	case "elys.clob.OrderKey.counter":
...
type fastReflection_PerpetualOrderOwner PerpetualOrderOwner

func (x *PerpetualOrderOwner) ProtoReflect() protoreflect.Message {
	return (*fastReflection_PerpetualOrderOwner)(x)
}

func (x *PerpetualOrderOwner) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_clob_order_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_PerpetualOrderOwner_messageType fastReflection_PerpetualOrderOwner_messageType
var _ protoreflect.MessageType = fastReflection_PerpetualOrderOwner_messageType{}

type fastReflection_PerpetualOrderOwner_messageType struct{}

func (x fastReflection_PerpetualOrderOwner_messageType) Zero() protoreflect.Message {
	return (*fastReflection_PerpetualOrderOwner)(nil)
}
func (x fastReflection_PerpetualOrderOwner_messageType) New() protoreflect.Message {
	return new(fastReflection_PerpetualOrderOwner)
}
func (x fastReflection_PerpetualOrderOwner_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_PerpetualOrderOwner
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_PerpetualOrderOwner) Descriptor() protoreflect.MessageDescriptor {
	return md_PerpetualOrderOwner
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_PerpetualOrderOwner) Type() protoreflect.MessageType {
	return _fastReflection_PerpetualOrderOwner_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_PerpetualOrderOwner) New() protoreflect.Message {
	return new(fastReflection_PerpetualOrderOwner)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_PerpetualOrderOwner) Interface() protoreflect.ProtoMessage {
	return (*PerpetualOrderOwner)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_PerpetualOrderOwner) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Owner != "" {
		value := protoreflect.ValueOfString(x.Owner)
		if !f(fd_PerpetualOrderOwner_owner, value) {
			return
		}
	}
	if x.SubAccountId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.SubAccountId)
		if !f(fd_PerpetualOrderOwner_sub_account_id, value) {
			return
		}
	}
	if x.OrderKey != nil {
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_PerpetualOrderOwner) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	...
	default:
		...
		panic(fmt.Errorf("message elys.clob.PerpetualOrderOwner does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PerpetualOrderOwner) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.clob.PerpetualOrderOwner.owner":
		x.Owner = ""
	case "elys.clob.PerpetualOrderOwner.sub_account_id":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_PerpetualOrderOwner) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.clob.PerpetualOrderOwner.owner":
		value := x.Owner
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message elys.clob.PerpetualOrderOwner does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PerpetualOrderOwner) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.clob.PerpetualOrderOwner.owner":
		x.Owner = value.Interface().(string)
	case "elys.clob.PerpetualOrderOwner.sub_account_id":
...
func (x *fastReflection_PerpetualOrderOwner) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.clob.PerpetualOrderOwner.sub_account_id":
		panic(fmt.Errorf("field sub_account_id of message elys.clob.PerpetualOrderOwner is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.clob.PerpetualOrderOwner"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_PerpetualOrderOwner) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.clob.PerpetualOrderOwner.owner":
		return protoreflect.ValueOfString("")
	case "elys.clob.PerpetualOrderOwner.sub_account_id":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_PerpetualOrderOwner) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.clob.PerpetualOrderOwner", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_PerpetualOrderOwner) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PerpetualOrderOwner) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_PerpetualOrderOwner) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_PerpetualOrderOwner) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*PerpetualOrderOwner)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: PerpetualOrderOwner: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: PerpetualOrderOwner: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *PerpetualOrder) GetSubAccountId() uint64 {
	if x != nil {
...
func (x *OrderKey) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
func (x *PerpetualOrderOwner) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PerpetualOrderOwner) ProtoMessage() {}

// Deprecated: Use PerpetualOrderOwner.ProtoReflect.Descriptor instead.
func (*PerpetualOrderOwner) Descriptor() ([]byte, []int) {
	return file_elys_clob_order_proto_rawDescGZIP(), []int{2}
}

func (x *PerpetualOrderOwner) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *PerpetualOrderOwner) GetSubAccountId() uint64 {
	if x != nil {
		return x.SubAccountId
	}
	return 0
...
var file_elys_clob_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xb1, 0x03, 0x0a, 0x0e, 0x50, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61,
	...
	0x28, 0x04, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x05, 0x6f,
	0x77, 0x6e, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xd2, 0xb4, 0x2d, 0x14,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x0e, 0x73,
	0x75, 0x62, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x0c, 0x73, 0x75, 0x62, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49,
	0x64, 0x12, 0x49, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x2e, 0x44, 0x65, 0x63, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x49, 0x0a, 0x06,
	0x66, 0x69, 0x6c, 0x6c, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde,
	...
	0x06, 0x66, 0x69, 0x6c, 0x6c, 0x65, 0x64, 0x22, 0xbf, 0x01, 0x0a, 0x08, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x4b, 0x65, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x49,
	0x64, 0x12, 0x33, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x63, 0x6c, 0x6f,
	0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x09, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x47, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18,
	...
	0x18, 0x0a, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x22, 0xa3, 0x01, 0x0a, 0x13, 0x50, 0x65,
	0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4f, 0x77, 0x6e, 0x65,
	0x72, 0x12, 0x2e, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x09, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x65, 0x6c, 0x79,
	0x73, 0x2e, 0x63, 0x6c, 0x6f, 0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4b, 0x65, 0x79, 0x42,
	0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4b, 0x65, 0x79, 0x2a,
	0x93, 0x01, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a,
	...
	,
...
func file_elys_clob_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_elys_clob_order_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PerpetualOrderOwner); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
