...
var (
	...
	fd_PerpetualOrder_perpetual_id   protoreflect.FieldDescriptor
...
func init() {
	...
	fd_PerpetualOrder_perpetual_id = md_PerpetualOrder.Fields().ByName("perpetual_id")
...
func (x *fastReflection_PerpetualOrder) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PerpetualId != uint64(0) {
		...
		if !f(fd_PerpetualOrder_perpetual_id, value) {
			return
		}
	}
	if x.Collateral != "" {
...
func (x *fastReflection_PerpetualOrder) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.clob.PerpetualOrder.perpetual_id":
		return x.PerpetualId != uint64(0)
	case "elys.clob.PerpetualOrder.collateral":
		return x.Collateral != ""
	case "elys.clob.PerpetualOrder.leverage":
		return x.Leverage != ""
...
func (x *fastReflection_PerpetualOrder) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.clob.PerpetualOrder.perpetual_id":
		panic(fmt.Errorf("field perpetual_id of message elys.clob.PerpetualOrder is not mutable"))
	case "elys.clob.PerpetualOrder.collateral":
		panic(fmt.Errorf("field collateral of message elys.clob.PerpetualOrder is not mutable"))
	case "elys.clob.PerpetualOrder.leverage":
		panic(fmt.Errorf("field leverage of message elys.clob.PerpetualOrder is not mutable"))
	case "elys.clob.PerpetualOrder.filled":
...
func (x *PerpetualOrder) GetPerpetualId() uint64 {
	if x != nil {
...
func (x *PerpetualOrder) GetCollateral() string {
	if x != nil {
		return x.Collateral
	}
	return ""
...
var file_elys_clob_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xae, 0x04, 0x0a, 0x0e, 0x50, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61,
	...
	0x62, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x65,
	0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x0b, 0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x4b, 0x0a,
	0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28,
	...
	0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde,
	...
	0x08, 0x6c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x49, 0x0a, 0x06, 0x66, 0x69, 0x6c,
	0x6c, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde, 0x1f, 0x00, 0xda,
	...
	0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x06, 0x66, 0x69,
	0x6c, 0x6c, 0x65, 0x64, 0x2a, 0x93, 0x01, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79,
	...
	0x4b, 0x45, 0x54, 0x5f, 0x53, 0x45, 0x4c, 0x4c, 0x10, 0x04, 0x42, 0x8c, 0x01, 0x0a, 0x0d, 0x63,
	0x6f, 0x6d, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x63, 0x6c, 0x6f, 0x62, 0x42, 0x0a, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68,
