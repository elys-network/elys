...
var file_elys_commitment_params_proto_rawDesc = []byte{
	...
	0x72, 0x4f, 0x66, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xef,
...
var file_elys_commitment_params_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_elys_commitment_params_proto_goTypes = []interface{}{
	...
	(*VestingInfo)(nil),  // 2: elys.commitment.VestingInfo
	(*v1beta1.Coin)(nil), // 3: cosmos.base.v1beta1.Coin
}
var file_elys_commitment_params_proto_depIdxs = []int32{
	2, // 0: elys.commitment.Params.vesting_infos:type_name -> elys.commitment.VestingInfo
	3, // 1: elys.commitment.Params.total_committed:type_name -> cosmos.base.v1beta1.Coin
