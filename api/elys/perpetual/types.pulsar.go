...
var (
	md_ToPay               protoreflect.MessageDescriptor
	fd_ToPay_asset_balance protoreflect.FieldDescriptor
	fd_ToPay_asset_denom   protoreflect.FieldDescriptor
	fd_ToPay_address       protoreflect.FieldDescriptor
	fd_ToPay_id            protoreflect.FieldDescriptor
)

func init() {
	file_elys_perpetual_types_proto_init()
	md_ToPay = File_elys_perpetual_types_proto.Messages().ByName("ToPay")
	fd_ToPay_asset_balance = md_ToPay.Fields().ByName("asset_balance")
	fd_ToPay_asset_denom = md_ToPay.Fields().ByName("asset_denom")
	fd_ToPay_address = md_ToPay.Fields().ByName("address")
	fd_ToPay_id = md_ToPay.Fields().ByName("id")
}

var _ protoreflect.Message = (*fastReflection_ToPay)(nil)

type fastReflection_ToPay ToPay

func (x *ToPay) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ToPay)(x)
}

func (x *ToPay) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_ToPay_messageType fastReflection_ToPay_messageType
var _ protoreflect.MessageType = fastReflection_ToPay_messageType{}

type fastReflection_ToPay_messageType struct{}

func (x fastReflection_ToPay_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ToPay)(nil)
}
func (x fastReflection_ToPay_messageType) New() protoreflect.Message {
	return new(fastReflection_ToPay)
}
func (x fastReflection_ToPay_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ToPay
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ToPay) Descriptor() protoreflect.MessageDescriptor {
	return md_ToPay
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ToPay) Type() protoreflect.MessageType {
	return _fastReflection_ToPay_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ToPay) New() protoreflect.Message {
	return new(fastReflection_ToPay)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ToPay) Interface() protoreflect.ProtoMessage {
	return (*ToPay)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ToPay) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AssetBalance != "" {
		value := protoreflect.ValueOfString(x.AssetBalance)
		if !f(fd_ToPay_asset_balance, value) {
			return
		}
	}
	if x.AssetDenom != "" {
		value := protoreflect.ValueOfString(x.AssetDenom)
		if !f(fd_ToPay_asset_denom, value) {
			return
		}
	}
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_ToPay_address, value) {
			return
		}
	}
	if x.Id != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Id)
		if !f(fd_ToPay_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ToPay) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.perpetual.ToPay.asset_balance":
		return x.AssetBalance != ""
	case "elys.perpetual.ToPay.asset_denom":
		return x.AssetDenom != ""
	case "elys.perpetual.ToPay.address":
		return x.Address != ""
	case "elys.perpetual.ToPay.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.ToPay"))
		}
		panic(fmt.Errorf("message elys.perpetual.ToPay does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToPay) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.perpetual.ToPay.asset_balance":
		x.AssetBalance = ""
	case "elys.perpetual.ToPay.asset_denom":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ToPay) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.perpetual.ToPay.asset_balance":
		value := x.AssetBalance
		return protoreflect.ValueOfString(value)
	case "elys.perpetual.ToPay.asset_denom":
		value := x.AssetDenom
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message elys.perpetual.ToPay does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToPay) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.perpetual.ToPay.asset_balance":
		x.AssetBalance = value.Interface().(string)
	case "elys.perpetual.ToPay.asset_denom":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToPay) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.ToPay.asset_balance":
		panic(fmt.Errorf("field asset_balance of message elys.perpetual.ToPay is not mutable"))
	case "elys.perpetual.ToPay.asset_denom":
		panic(fmt.Errorf("field asset_denom of message elys.perpetual.ToPay is not mutable"))
	case "elys.perpetual.ToPay.address":
		panic(fmt.Errorf("field address of message elys.perpetual.ToPay is not mutable"))
	case "elys.perpetual.ToPay.id":
		panic(fmt.Errorf("field id of message elys.perpetual.ToPay is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.ToPay"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ToPay) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.ToPay.asset_balance":
		return protoreflect.ValueOfString("")
	case "elys.perpetual.ToPay.asset_denom":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ToPay) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.ToPay", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ToPay) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ToPay) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ToPay) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ToPay) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ToPay)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AssetBalance) > 0 {
			i -= len(x.AssetBalance)
			copy(dAtA[i:], x.AssetBalance)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AssetBalance)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ToPay: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ToPay: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AssetBalance", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AssetBalance = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
...
type ToPay struct {
	...
	AssetBalance string `protobuf:"bytes,1,opt,name=asset_balance,json=assetBalance,proto3" json:"asset_balance,omitempty"`
...
func (x *ToPay) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ToPay) ProtoMessage() {}

// Deprecated: Use ToPay.ProtoReflect.Descriptor instead.
func (*ToPay) Descriptor() ([]byte, []int) {
	return file_elys_perpetual_types_proto_rawDescGZIP(), []int{3}
}

func (x *ToPay) GetAssetBalance() string {
	if x != nil {
		return x.AssetBalance
	}
	return ""
...
func (x *ToPay) GetAssetDenom() string {
	if x != nil {
		return x.AssetDenom
	}
	return ""
...
func (x *ToPay) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
var file_elys_perpetual_types_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x6b, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xa4, 0x01, 0x0a, 0x05, 0x54, 0x6f, 0x50, 0x61,
	0x79, 0x12, 0x50, 0x0a, 0x0d, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x62, 0x61, 0x6c, 0x61, 0x6e,
	...
	0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x0c, 0x61, 0x73, 0x73, 0x65, 0x74, 0x42, 0x61, 0x6c, 0x61,
	0x6e, 0x63, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x64, 0x65, 0x6e,
	0x6f, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x73, 0x73, 0x65, 0x74, 0x44,
	...
	,
	...
	0x02, 0x42, 0x9a, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x70,
	0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x42, 0x0a, 0x54, 0x79, 0x70, 0x65, 0x73, 0x50,
...
var file_elys_perpetual_types_proto_goTypes = []interface{}{
	...
	(*ToPay)(nil),            // 4: elys.perpetual.ToPay
	(*WhiteList)(nil),        // 5: elys.perpetual.WhiteList
	(*PositionRequest)(nil),  // 6: elys.perpetual.PositionRequest
}
