...
const (
	Msg_Open_FullMethodName                     = "/elys.perpetual.Msg/Open"
	Msg_Close_FullMethodName                    = "/elys.perpetual.Msg/Close"
	Msg_UpdateParams_FullMethodName             = "/elys.perpetual.Msg/UpdateParams"
	Msg_Whitelist_FullMethodName                = "/elys.perpetual.Msg/Whitelist"
	Msg_Dewhitelist_FullMethodName              = "/elys.perpetual.Msg/Dewhitelist"
	Msg_UpdateStopLoss_FullMethodName           = "/elys.perpetual.Msg/UpdateStopLoss"
	Msg_ClosePositions_FullMethodName           = "/elys.perpetual.Msg/ClosePositions"
	Msg_UpdateTakeProfitPrice_FullMethodName    = "/elys.perpetual.Msg/UpdateTakeProfitPrice"
	Msg_UpdateMaxLeverageForPool_FullMethodName = "/elys.perpetual.Msg/UpdateMaxLeverageForPool"
	Msg_UpdateEnabledPools_FullMethodName       = "/elys.perpetual.Msg/UpdateEnabledPools"
)
...
func (c *msgClient) UpdateTakeProfitPrice(ctx context.Context, in *MsgUpdateTakeProfitPrice, opts ...grpc.CallOption) (*MsgUpdateTakeProfitPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateTakeProfitPrice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateTakeProfitPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UpdateTakeProfitPrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
