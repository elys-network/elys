...
var (
	...
	fd_MTPRequest_pool_id protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MTPRequest_pool_id = md_MTPRequest.Fields().ByName("pool_id")
}
...
func (x *fastReflection_MTPRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PoolId != uint64(0) {
		...
		if !f(fd_MTPRequest_pool_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_MTPRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.perpetual.MTPRequest.id":
		return x.Id != uint64(0)
	case "elys.perpetual.MTPRequest.pool_id":
...
func (x *fastReflection_MTPRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.perpetual.MTPRequest.pool_id":
		panic(fmt.Errorf("field pool_id of message elys.perpetual.MTPRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.MTPRequest"))
		}
...
var (
	...
	fd_QueryOpenEstimationResponse_swap_fees            protoreflect.FieldDescriptor
	fd_QueryOpenEstimationResponse_taker_fees           protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QueryOpenEstimationResponse_swap_fees = md_QueryOpenEstimationResponse.Fields().ByName("swap_fees")
	fd_QueryOpenEstimationResponse_taker_fees = md_QueryOpenEstimationResponse.Fields().ByName("taker_fees")
}
...
func (x *fastReflection_QueryOpenEstimationResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SwapFees != "" {
		value := protoreflect.ValueOfString(x.SwapFees)
		if !f(fd_QueryOpenEstimationResponse_swap_fees, value) {
			return
		}
	}
	if x.TakerFees != "" {
		value := protoreflect.ValueOfString(x.TakerFees)
		if !f(fd_QueryOpenEstimationResponse_taker_fees, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryOpenEstimationResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.perpetual.QueryOpenEstimationResponse.swap_fees":
		return x.SwapFees != ""
	case "elys.perpetual.QueryOpenEstimationResponse.taker_fees":
		return x.TakerFees != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_QueryOpenEstimationResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "elys.perpetual.QueryOpenEstimationResponse.swap_fees":
		x.SwapFees = value.Interface().(string)
	case "elys.perpetual.QueryOpenEstimationResponse.taker_fees":
...
func (x *fastReflection_QueryOpenEstimationResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.perpetual.QueryOpenEstimationResponse.swap_fees":
		panic(fmt.Errorf("field swap_fees of message elys.perpetual.QueryOpenEstimationResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationResponse.taker_fees":
		panic(fmt.Errorf("field taker_fees of message elys.perpetual.QueryOpenEstimationResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryOpenEstimationResponse"))
		}
...
func (x *fastReflection_QueryOpenEstimationResponse) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.SwapFees) > 0 {
			i -= len(x.SwapFees)
			copy(dAtA[i:], x.SwapFees)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.SwapFees)))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa2
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 20:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field SwapFees", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.SwapFees = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 21:
				if wireType != 2 {
...
var (
	...
	fd_QueryCloseEstimationRequest_pool_id      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QueryCloseEstimationRequest_pool_id = md_QueryCloseEstimationRequest.Fields().ByName("pool_id")
}
...
func (x *fastReflection_QueryCloseEstimationRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.PoolId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.PoolId)
		if !f(fd_QueryCloseEstimationRequest_pool_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryCloseEstimationRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "elys.perpetual.QueryCloseEstimationRequest.pool_id":
		return x.PoolId != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_QueryCloseEstimationRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "elys.perpetual.QueryCloseEstimationRequest.pool_id":
		panic(fmt.Errorf("field pool_id of message elys.perpetual.QueryCloseEstimationRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryCloseEstimationRequest"))
		}
...
var (
	md_QueryOpenEstimationByFinalRequest                   protoreflect.MessageDescriptor
	fd_QueryOpenEstimationByFinalRequest_position          protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalRequest_leverage          protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalRequest_final_amount      protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalRequest_address           protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalRequest_take_profit_price protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalRequest_poolId            protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalRequest_collateral_denom  protoreflect.FieldDescriptor
)

func init() {
	file_elys_perpetual_query_proto_init()
	md_QueryOpenEstimationByFinalRequest = File_elys_perpetual_query_proto.Messages().ByName("QueryOpenEstimationByFinalRequest")
	fd_QueryOpenEstimationByFinalRequest_position = md_QueryOpenEstimationByFinalRequest.Fields().ByName("position")
	fd_QueryOpenEstimationByFinalRequest_leverage = md_QueryOpenEstimationByFinalRequest.Fields().ByName("leverage")
	fd_QueryOpenEstimationByFinalRequest_final_amount = md_QueryOpenEstimationByFinalRequest.Fields().ByName("final_amount")
	fd_QueryOpenEstimationByFinalRequest_address = md_QueryOpenEstimationByFinalRequest.Fields().ByName("address")
	fd_QueryOpenEstimationByFinalRequest_take_profit_price = md_QueryOpenEstimationByFinalRequest.Fields().ByName("take_profit_price")
	fd_QueryOpenEstimationByFinalRequest_poolId = md_QueryOpenEstimationByFinalRequest.Fields().ByName("poolId")
	fd_QueryOpenEstimationByFinalRequest_collateral_denom = md_QueryOpenEstimationByFinalRequest.Fields().ByName("collateral_denom")
}

var _ protoreflect.Message = (*fastReflection_QueryOpenEstimationByFinalRequest)(nil)

type fastReflection_QueryOpenEstimationByFinalRequest QueryOpenEstimationByFinalRequest

func (x *QueryOpenEstimationByFinalRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryOpenEstimationByFinalRequest)(x)
}

func (x *QueryOpenEstimationByFinalRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_perpetual_query_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryOpenEstimationByFinalRequest_messageType fastReflection_QueryOpenEstimationByFinalRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryOpenEstimationByFinalRequest_messageType{}

type fastReflection_QueryOpenEstimationByFinalRequest_messageType struct{}

func (x fastReflection_QueryOpenEstimationByFinalRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryOpenEstimationByFinalRequest)(nil)
}
func (x fastReflection_QueryOpenEstimationByFinalRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryOpenEstimationByFinalRequest)
}
func (x fastReflection_QueryOpenEstimationByFinalRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryOpenEstimationByFinalRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryOpenEstimationByFinalRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryOpenEstimationByFinalRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) New() protoreflect.Message {
	return new(fastReflection_QueryOpenEstimationByFinalRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryOpenEstimationByFinalRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Position != 0 {
		value := protoreflect.ValueOfEnum((protoreflect.EnumNumber)(x.Position))
		if !f(fd_QueryOpenEstimationByFinalRequest_position, value) {
			return
		}
	}
	if x.Leverage != "" {
		value := protoreflect.ValueOfString(x.Leverage)
		if !f(fd_QueryOpenEstimationByFinalRequest_leverage, value) {
			return
		}
	}
	if x.FinalAmount != nil {
		value := protoreflect.ValueOfMessage(x.FinalAmount.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalRequest_final_amount, value) {
			return
		}
	}
	if x.Address != "" {
		value := protoreflect.ValueOfString(x.Address)
		if !f(fd_QueryOpenEstimationByFinalRequest_address, value) {
			return
		}
	}
	if x.TakeProfitPrice != "" {
		value := protoreflect.ValueOfString(x.TakeProfitPrice)
		if !f(fd_QueryOpenEstimationByFinalRequest_take_profit_price, value) {
			return
		}
	}
	if x.PoolId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.PoolId)
		if !f(fd_QueryOpenEstimationByFinalRequest_poolId, value) {
			return
		}
	}
	if x.CollateralDenom != "" {
		value := protoreflect.ValueOfString(x.CollateralDenom)
		if !f(fd_QueryOpenEstimationByFinalRequest_collateral_denom, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.position":
		return x.Position != 0
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.leverage":
		return x.Leverage != ""
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.final_amount":
		return x.FinalAmount != nil
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.address":
		return x.Address != ""
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.take_profit_price":
		return x.TakeProfitPrice != ""
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.poolId":
		return x.PoolId != uint64(0)
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.collateral_denom":
		return x.CollateralDenom != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryOpenEstimationByFinalRequest"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryOpenEstimationByFinalRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.position":
		x.Position = 0
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.leverage":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.position":
		value := x.Position
		return protoreflect.ValueOfEnum((protoreflect.EnumNumber)(value))
	...
	default:
		...
		panic(fmt.Errorf("message elys.perpetual.QueryOpenEstimationByFinalRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.position":
		x.Position = (Position)(value.Enum())
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.leverage":
		x.Leverage = value.Interface().(string)
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.final_amount":
		x.FinalAmount = value.Message().Interface().(*v1beta1.Coin)
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.address":
		x.Address = value.Interface().(string)
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.take_profit_price":
		x.TakeProfitPrice = value.Interface().(string)
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.final_amount":
		if x.FinalAmount == nil {
			x.FinalAmount = new(v1beta1.Coin)
		}
		return protoreflect.ValueOfMessage(x.FinalAmount.ProtoReflect())
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.position":
		panic(fmt.Errorf("field position of message elys.perpetual.QueryOpenEstimationByFinalRequest is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.leverage":
		panic(fmt.Errorf("field leverage of message elys.perpetual.QueryOpenEstimationByFinalRequest is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.address":
		panic(fmt.Errorf("field address of message elys.perpetual.QueryOpenEstimationByFinalRequest is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.take_profit_price":
		panic(fmt.Errorf("field take_profit_price of message elys.perpetual.QueryOpenEstimationByFinalRequest is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.poolId":
		panic(fmt.Errorf("field poolId of message elys.perpetual.QueryOpenEstimationByFinalRequest is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.collateral_denom":
		panic(fmt.Errorf("field collateral_denom of message elys.perpetual.QueryOpenEstimationByFinalRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryOpenEstimationByFinalRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.position":
		return protoreflect.ValueOfEnum(0)
	case "elys.perpetual.QueryOpenEstimationByFinalRequest.leverage":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.QueryOpenEstimationByFinalRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryOpenEstimationByFinalRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryOpenEstimationByFinalRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.FinalAmount != nil {
			encoded, err := options.Marshal(x.FinalAmount)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryOpenEstimationByFinalRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryOpenEstimationByFinalRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
			...
			case 3:
				...
				if x.FinalAmount == nil {
					x.FinalAmount = &v1beta1.Coin{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.FinalAmount); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 4:
...
var (
	md_QueryOpenEstimationByFinalResponse                      protoreflect.MessageDescriptor
	fd_QueryOpenEstimationByFinalResponse_position             protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_effective_leverage   protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_collateral           protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_hourly_interest_rate protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_position_size        protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_open_price           protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_take_profit_price    protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_liquidation_price    protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_estimated_pnl        protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_available_liquidity  protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_slippage             protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_borrow_interest_rate protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_funding_rate         protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_price_impact         protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_custody              protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_liabilities          protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_limit_price          protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_weight_breaking_fee  protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_swap_fees            protoreflect.FieldDescriptor
	fd_QueryOpenEstimationByFinalResponse_taker_fees           protoreflect.FieldDescriptor
)

func init() {
	file_elys_perpetual_query_proto_init()
	md_QueryOpenEstimationByFinalResponse = File_elys_perpetual_query_proto.Messages().ByName("QueryOpenEstimationByFinalResponse")
	fd_QueryOpenEstimationByFinalResponse_position = md_QueryOpenEstimationByFinalResponse.Fields().ByName("position")
	fd_QueryOpenEstimationByFinalResponse_effective_leverage = md_QueryOpenEstimationByFinalResponse.Fields().ByName("effective_leverage")
	fd_QueryOpenEstimationByFinalResponse_collateral = md_QueryOpenEstimationByFinalResponse.Fields().ByName("collateral")
	fd_QueryOpenEstimationByFinalResponse_hourly_interest_rate = md_QueryOpenEstimationByFinalResponse.Fields().ByName("hourly_interest_rate")
	fd_QueryOpenEstimationByFinalResponse_position_size = md_QueryOpenEstimationByFinalResponse.Fields().ByName("position_size")
	fd_QueryOpenEstimationByFinalResponse_open_price = md_QueryOpenEstimationByFinalResponse.Fields().ByName("open_price")
	fd_QueryOpenEstimationByFinalResponse_take_profit_price = md_QueryOpenEstimationByFinalResponse.Fields().ByName("take_profit_price")
	fd_QueryOpenEstimationByFinalResponse_liquidation_price = md_QueryOpenEstimationByFinalResponse.Fields().ByName("liquidation_price")
	fd_QueryOpenEstimationByFinalResponse_estimated_pnl = md_QueryOpenEstimationByFinalResponse.Fields().ByName("estimated_pnl")
	fd_QueryOpenEstimationByFinalResponse_available_liquidity = md_QueryOpenEstimationByFinalResponse.Fields().ByName("available_liquidity")
	fd_QueryOpenEstimationByFinalResponse_slippage = md_QueryOpenEstimationByFinalResponse.Fields().ByName("slippage")
	fd_QueryOpenEstimationByFinalResponse_borrow_interest_rate = md_QueryOpenEstimationByFinalResponse.Fields().ByName("borrow_interest_rate")
	fd_QueryOpenEstimationByFinalResponse_funding_rate = md_QueryOpenEstimationByFinalResponse.Fields().ByName("funding_rate")
	fd_QueryOpenEstimationByFinalResponse_price_impact = md_QueryOpenEstimationByFinalResponse.Fields().ByName("price_impact")
	fd_QueryOpenEstimationByFinalResponse_custody = md_QueryOpenEstimationByFinalResponse.Fields().ByName("custody")
	fd_QueryOpenEstimationByFinalResponse_liabilities = md_QueryOpenEstimationByFinalResponse.Fields().ByName("liabilities")
	fd_QueryOpenEstimationByFinalResponse_limit_price = md_QueryOpenEstimationByFinalResponse.Fields().ByName("limit_price")
	fd_QueryOpenEstimationByFinalResponse_weight_breaking_fee = md_QueryOpenEstimationByFinalResponse.Fields().ByName("weight_breaking_fee")
	fd_QueryOpenEstimationByFinalResponse_swap_fees = md_QueryOpenEstimationByFinalResponse.Fields().ByName("swap_fees")
	fd_QueryOpenEstimationByFinalResponse_taker_fees = md_QueryOpenEstimationByFinalResponse.Fields().ByName("taker_fees")
}

var _ protoreflect.Message = (*fastReflection_QueryOpenEstimationByFinalResponse)(nil)

type fastReflection_QueryOpenEstimationByFinalResponse QueryOpenEstimationByFinalResponse

func (x *QueryOpenEstimationByFinalResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryOpenEstimationByFinalResponse)(x)
}

func (x *QueryOpenEstimationByFinalResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_perpetual_query_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryOpenEstimationByFinalResponse_messageType fastReflection_QueryOpenEstimationByFinalResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryOpenEstimationByFinalResponse_messageType{}

type fastReflection_QueryOpenEstimationByFinalResponse_messageType struct{}

func (x fastReflection_QueryOpenEstimationByFinalResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryOpenEstimationByFinalResponse)(nil)
}
func (x fastReflection_QueryOpenEstimationByFinalResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryOpenEstimationByFinalResponse)
}
func (x fastReflection_QueryOpenEstimationByFinalResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryOpenEstimationByFinalResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryOpenEstimationByFinalResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryOpenEstimationByFinalResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) New() protoreflect.Message {
	return new(fastReflection_QueryOpenEstimationByFinalResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryOpenEstimationByFinalResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Position != 0 {
		value := protoreflect.ValueOfEnum((protoreflect.EnumNumber)(x.Position))
		if !f(fd_QueryOpenEstimationByFinalResponse_position, value) {
			return
		}
	}
	if x.EffectiveLeverage != "" {
		value := protoreflect.ValueOfString(x.EffectiveLeverage)
		if !f(fd_QueryOpenEstimationByFinalResponse_effective_leverage, value) {
			return
		}
	}
	if x.Collateral != nil {
		value := protoreflect.ValueOfMessage(x.Collateral.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalResponse_collateral, value) {
			return
		}
	}
	if x.HourlyInterestRate != "" {
		value := protoreflect.ValueOfString(x.HourlyInterestRate)
		if !f(fd_QueryOpenEstimationByFinalResponse_hourly_interest_rate, value) {
			return
		}
	}
	if x.PositionSize != nil {
		value := protoreflect.ValueOfMessage(x.PositionSize.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalResponse_position_size, value) {
			return
		}
	}
	if x.OpenPrice != "" {
		value := protoreflect.ValueOfString(x.OpenPrice)
		if !f(fd_QueryOpenEstimationByFinalResponse_open_price, value) {
			return
		}
	}
	if x.TakeProfitPrice != "" {
		value := protoreflect.ValueOfString(x.TakeProfitPrice)
		if !f(fd_QueryOpenEstimationByFinalResponse_take_profit_price, value) {
			return
		}
	}
	if x.LiquidationPrice != "" {
		value := protoreflect.ValueOfString(x.LiquidationPrice)
		if !f(fd_QueryOpenEstimationByFinalResponse_liquidation_price, value) {
			return
		}
	}
	if x.EstimatedPnl != nil {
		value := protoreflect.ValueOfMessage(x.EstimatedPnl.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalResponse_estimated_pnl, value) {
			return
		}
	}
	if x.AvailableLiquidity != nil {
		value := protoreflect.ValueOfMessage(x.AvailableLiquidity.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalResponse_available_liquidity, value) {
			return
		}
	}
	if x.Slippage != "" {
		value := protoreflect.ValueOfString(x.Slippage)
		if !f(fd_QueryOpenEstimationByFinalResponse_slippage, value) {
			return
		}
	}
	if x.BorrowInterestRate != "" {
		value := protoreflect.ValueOfString(x.BorrowInterestRate)
		if !f(fd_QueryOpenEstimationByFinalResponse_borrow_interest_rate, value) {
			return
		}
	}
	if x.FundingRate != "" {
		value := protoreflect.ValueOfString(x.FundingRate)
		if !f(fd_QueryOpenEstimationByFinalResponse_funding_rate, value) {
			return
		}
	}
	if x.PriceImpact != "" {
		value := protoreflect.ValueOfString(x.PriceImpact)
		if !f(fd_QueryOpenEstimationByFinalResponse_price_impact, value) {
			return
		}
	}
	if x.Custody != nil {
		value := protoreflect.ValueOfMessage(x.Custody.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalResponse_custody, value) {
			return
		}
	}
	if x.Liabilities != nil {
		value := protoreflect.ValueOfMessage(x.Liabilities.ProtoReflect())
		if !f(fd_QueryOpenEstimationByFinalResponse_liabilities, value) {
			return
		}
	}
	if x.LimitPrice != "" {
		value := protoreflect.ValueOfString(x.LimitPrice)
		if !f(fd_QueryOpenEstimationByFinalResponse_limit_price, value) {
			return
		}
	}
	if x.WeightBreakingFee != "" {
		value := protoreflect.ValueOfString(x.WeightBreakingFee)
		if !f(fd_QueryOpenEstimationByFinalResponse_weight_breaking_fee, value) {
			return
		}
	}
	if x.SwapFees != "" {
		value := protoreflect.ValueOfString(x.SwapFees)
		if !f(fd_QueryOpenEstimationByFinalResponse_swap_fees, value) {
			return
		}
	}
	if x.TakerFees != "" {
		value := protoreflect.ValueOfString(x.TakerFees)
		if !f(fd_QueryOpenEstimationByFinalResponse_taker_fees, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position":
		return x.Position != 0
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.effective_leverage":
		return x.EffectiveLeverage != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.collateral":
		return x.Collateral != nil
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.hourly_interest_rate":
		return x.HourlyInterestRate != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position_size":
		return x.PositionSize != nil
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.open_price":
		return x.OpenPrice != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.take_profit_price":
		return x.TakeProfitPrice != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.liquidation_price":
		return x.LiquidationPrice != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.estimated_pnl":
		return x.EstimatedPnl != nil
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.available_liquidity":
		return x.AvailableLiquidity != nil
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.slippage":
		return x.Slippage != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.borrow_interest_rate":
		return x.BorrowInterestRate != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.funding_rate":
		return x.FundingRate != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.price_impact":
		return x.PriceImpact != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.custody":
		return x.Custody != nil
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.liabilities":
		return x.Liabilities != nil
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.limit_price":
		return x.LimitPrice != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.weight_breaking_fee":
		return x.WeightBreakingFee != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.swap_fees":
		return x.SwapFees != ""
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.taker_fees":
		return x.TakerFees != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryOpenEstimationByFinalResponse"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryOpenEstimationByFinalResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position":
		x.Position = 0
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.effective_leverage":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position":
		value := x.Position
		return protoreflect.ValueOfEnum((protoreflect.EnumNumber)(value))
	...
	default:
		...
		panic(fmt.Errorf("message elys.perpetual.QueryOpenEstimationByFinalResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position":
		x.Position = (Position)(value.Enum())
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.effective_leverage":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.collateral":
		if x.Collateral == nil {
			x.Collateral = new(v1beta1.Coin)
	...
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.liabilities":
		...
		return protoreflect.ValueOfMessage(x.Liabilities.ProtoReflect())
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position":
		panic(fmt.Errorf("field position of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.effective_leverage":
		panic(fmt.Errorf("field effective_leverage of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.hourly_interest_rate":
		panic(fmt.Errorf("field hourly_interest_rate of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.open_price":
		panic(fmt.Errorf("field open_price of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.take_profit_price":
		panic(fmt.Errorf("field take_profit_price of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.liquidation_price":
		panic(fmt.Errorf("field liquidation_price of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.slippage":
		panic(fmt.Errorf("field slippage of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.borrow_interest_rate":
		panic(fmt.Errorf("field borrow_interest_rate of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.funding_rate":
		panic(fmt.Errorf("field funding_rate of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.price_impact":
		panic(fmt.Errorf("field price_impact of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.limit_price":
		panic(fmt.Errorf("field limit_price of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.weight_breaking_fee":
		panic(fmt.Errorf("field weight_breaking_fee of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.swap_fees":
		panic(fmt.Errorf("field swap_fees of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.taker_fees":
		panic(fmt.Errorf("field taker_fees of message elys.perpetual.QueryOpenEstimationByFinalResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryOpenEstimationByFinalResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.position":
		return protoreflect.ValueOfEnum(0)
	case "elys.perpetual.QueryOpenEstimationByFinalResponse.effective_leverage":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.QueryOpenEstimationByFinalResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryOpenEstimationByFinalResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryOpenEstimationByFinalResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryOpenEstimationByFinalResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryOpenEstimationByFinalResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var (
	md_QueryInvariantCustodyLiabRequest            protoreflect.MessageDescriptor
	fd_QueryInvariantCustodyLiabRequest_pool_id    protoreflect.FieldDescriptor
	fd_QueryInvariantCustodyLiabRequest_pagination protoreflect.FieldDescriptor
)

func init() {
	file_elys_perpetual_query_proto_init()
	md_QueryInvariantCustodyLiabRequest = File_elys_perpetual_query_proto.Messages().ByName("QueryInvariantCustodyLiabRequest")
	fd_QueryInvariantCustodyLiabRequest_pool_id = md_QueryInvariantCustodyLiabRequest.Fields().ByName("pool_id")
	fd_QueryInvariantCustodyLiabRequest_pagination = md_QueryInvariantCustodyLiabRequest.Fields().ByName("pagination")
}

var _ protoreflect.Message = (*fastReflection_QueryInvariantCustodyLiabRequest)(nil)

type fastReflection_QueryInvariantCustodyLiabRequest QueryInvariantCustodyLiabRequest

func (x *QueryInvariantCustodyLiabRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryInvariantCustodyLiabRequest)(x)
}

func (x *QueryInvariantCustodyLiabRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_perpetual_query_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryInvariantCustodyLiabRequest_messageType fastReflection_QueryInvariantCustodyLiabRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryInvariantCustodyLiabRequest_messageType{}

type fastReflection_QueryInvariantCustodyLiabRequest_messageType struct{}

func (x fastReflection_QueryInvariantCustodyLiabRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryInvariantCustodyLiabRequest)(nil)
}
func (x fastReflection_QueryInvariantCustodyLiabRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryInvariantCustodyLiabRequest)
}
func (x fastReflection_QueryInvariantCustodyLiabRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryInvariantCustodyLiabRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryInvariantCustodyLiabRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryInvariantCustodyLiabRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) New() protoreflect.Message {
	return new(fastReflection_QueryInvariantCustodyLiabRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryInvariantCustodyLiabRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.PoolId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.PoolId)
		if !f(fd_QueryInvariantCustodyLiabRequest_pool_id, value) {
			return
		}
	}
	if x.Pagination != nil {
		value := protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
		if !f(fd_QueryInvariantCustodyLiabRequest_pagination, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pool_id":
		return x.PoolId != uint64(0)
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabRequest"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryInvariantCustodyLiabRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pool_id":
		x.PoolId = uint64(0)
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pagination":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pool_id":
		value := x.PoolId
		return protoreflect.ValueOfUint64(value)
	...
	default:
		...
		panic(fmt.Errorf("message elys.perpetual.QueryInvariantCustodyLiabRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pool_id":
		x.PoolId = value.Uint()
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pagination":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pagination":
		if x.Pagination == nil {
			x.Pagination = new(v1beta11.PageRequest)
		...
		return protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pool_id":
		panic(fmt.Errorf("field pool_id of message elys.perpetual.QueryInvariantCustodyLiabRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pool_id":
		return protoreflect.ValueOfUint64(uint64(0))
	case "elys.perpetual.QueryInvariantCustodyLiabRequest.pagination":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.QueryInvariantCustodyLiabRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryInvariantCustodyLiabRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryInvariantCustodyLiabRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryInvariantCustodyLiabRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryInvariantCustodyLiabRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var _ protoreflect.List = (*_QueryInvariantCustodyLiabResponse_1_list)(nil)

type _QueryInvariantCustodyLiabResponse_1_list struct {
	list *[]*v1beta1.Coin
}

func (x *_QueryInvariantCustodyLiabResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryInvariantCustodyLiabResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryInvariantCustodyLiabResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryInvariantCustodyLiabResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryInvariantCustodyLiabResponse_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_1_list) IsValid() bool {
	return x.list != nil
}

var _ protoreflect.List = (*_QueryInvariantCustodyLiabResponse_2_list)(nil)

type _QueryInvariantCustodyLiabResponse_2_list struct {
	list *[]*v1beta1.Coin
}

func (x *_QueryInvariantCustodyLiabResponse_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryInvariantCustodyLiabResponse_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryInvariantCustodyLiabResponse_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryInvariantCustodyLiabResponse_2_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_2_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryInvariantCustodyLiabResponse_2_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_2_list) IsValid() bool {
	return x.list != nil
}

var _ protoreflect.List = (*_QueryInvariantCustodyLiabResponse_3_list)(nil)

type _QueryInvariantCustodyLiabResponse_3_list struct {
	list *[]*v1beta1.Coin
}

func (x *_QueryInvariantCustodyLiabResponse_3_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryInvariantCustodyLiabResponse_3_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryInvariantCustodyLiabResponse_3_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryInvariantCustodyLiabResponse_3_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_3_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryInvariantCustodyLiabResponse_3_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_3_list) IsValid() bool {
	return x.list != nil
}

var _ protoreflect.List = (*_QueryInvariantCustodyLiabResponse_4_list)(nil)

type _QueryInvariantCustodyLiabResponse_4_list struct {
	list *[]*v1beta1.Coin
}

func (x *_QueryInvariantCustodyLiabResponse_4_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryInvariantCustodyLiabResponse_4_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_4_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryInvariantCustodyLiabResponse_4_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryInvariantCustodyLiabResponse_4_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_4_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryInvariantCustodyLiabResponse_4_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_4_list) IsValid() bool {
	return x.list != nil
}

var _ protoreflect.List = (*_QueryInvariantCustodyLiabResponse_5_list)(nil)

type _QueryInvariantCustodyLiabResponse_5_list struct {
	list *[]*v1beta1.Coin
}

func (x *_QueryInvariantCustodyLiabResponse_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryInvariantCustodyLiabResponse_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryInvariantCustodyLiabResponse_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryInvariantCustodyLiabResponse_5_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_5_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryInvariantCustodyLiabResponse_5_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_5_list) IsValid() bool {
	return x.list != nil
}

var _ protoreflect.List = (*_QueryInvariantCustodyLiabResponse_6_list)(nil)

type _QueryInvariantCustodyLiabResponse_6_list struct {
	list *[]*v1beta1.Coin
}

func (x *_QueryInvariantCustodyLiabResponse_6_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryInvariantCustodyLiabResponse_6_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_6_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryInvariantCustodyLiabResponse_6_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryInvariantCustodyLiabResponse_6_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_6_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryInvariantCustodyLiabResponse_6_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryInvariantCustodyLiabResponse_6_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryInvariantCustodyLiabResponse                                protoreflect.MessageDescriptor
	fd_QueryInvariantCustodyLiabResponse_total_custody                  protoreflect.FieldDescriptor
	fd_QueryInvariantCustodyLiabResponse_total_liabilities              protoreflect.FieldDescriptor
	fd_QueryInvariantCustodyLiabResponse_total_custody_without_lazy     protoreflect.FieldDescriptor
	fd_QueryInvariantCustodyLiabResponse_total_liabilities_without_lazy protoreflect.FieldDescriptor
	fd_QueryInvariantCustodyLiabResponse_pool_custody                   protoreflect.FieldDescriptor
	fd_QueryInvariantCustodyLiabResponse_pool_liabilities               protoreflect.FieldDescriptor
)

func init() {
	file_elys_perpetual_query_proto_init()
	md_QueryInvariantCustodyLiabResponse = File_elys_perpetual_query_proto.Messages().ByName("QueryInvariantCustodyLiabResponse")
	fd_QueryInvariantCustodyLiabResponse_total_custody = md_QueryInvariantCustodyLiabResponse.Fields().ByName("total_custody")
	fd_QueryInvariantCustodyLiabResponse_total_liabilities = md_QueryInvariantCustodyLiabResponse.Fields().ByName("total_liabilities")
	fd_QueryInvariantCustodyLiabResponse_total_custody_without_lazy = md_QueryInvariantCustodyLiabResponse.Fields().ByName("total_custody_without_lazy")
	fd_QueryInvariantCustodyLiabResponse_total_liabilities_without_lazy = md_QueryInvariantCustodyLiabResponse.Fields().ByName("total_liabilities_without_lazy")
	fd_QueryInvariantCustodyLiabResponse_pool_custody = md_QueryInvariantCustodyLiabResponse.Fields().ByName("pool_custody")
	fd_QueryInvariantCustodyLiabResponse_pool_liabilities = md_QueryInvariantCustodyLiabResponse.Fields().ByName("pool_liabilities")
}

var _ protoreflect.Message = (*fastReflection_QueryInvariantCustodyLiabResponse)(nil)

type fastReflection_QueryInvariantCustodyLiabResponse QueryInvariantCustodyLiabResponse

func (x *QueryInvariantCustodyLiabResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryInvariantCustodyLiabResponse)(x)
}

func (x *QueryInvariantCustodyLiabResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_elys_perpetual_query_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryInvariantCustodyLiabResponse_messageType fastReflection_QueryInvariantCustodyLiabResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryInvariantCustodyLiabResponse_messageType{}

type fastReflection_QueryInvariantCustodyLiabResponse_messageType struct{}

func (x fastReflection_QueryInvariantCustodyLiabResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryInvariantCustodyLiabResponse)(nil)
}
func (x fastReflection_QueryInvariantCustodyLiabResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryInvariantCustodyLiabResponse)
}
func (x fastReflection_QueryInvariantCustodyLiabResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryInvariantCustodyLiabResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryInvariantCustodyLiabResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryInvariantCustodyLiabResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) New() protoreflect.Message {
	return new(fastReflection_QueryInvariantCustodyLiabResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryInvariantCustodyLiabResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.TotalCustody) != 0 {
		value := protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_1_list{list: &x.TotalCustody})
		if !f(fd_QueryInvariantCustodyLiabResponse_total_custody, value) {
			return
		}
	}
	if len(x.TotalLiabilities) != 0 {
		value := protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_2_list{list: &x.TotalLiabilities})
		if !f(fd_QueryInvariantCustodyLiabResponse_total_liabilities, value) {
			return
		}
	}
	if len(x.TotalCustodyWithoutLazy) != 0 {
		value := protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_3_list{list: &x.TotalCustodyWithoutLazy})
		if !f(fd_QueryInvariantCustodyLiabResponse_total_custody_without_lazy, value) {
			return
		}
	}
	if len(x.TotalLiabilitiesWithoutLazy) != 0 {
		value := protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_4_list{list: &x.TotalLiabilitiesWithoutLazy})
		if !f(fd_QueryInvariantCustodyLiabResponse_total_liabilities_without_lazy, value) {
			return
		}
	}
	if len(x.PoolCustody) != 0 {
		value := protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_5_list{list: &x.PoolCustody})
		if !f(fd_QueryInvariantCustodyLiabResponse_pool_custody, value) {
			return
		}
	}
	if len(x.PoolLiabilities) != 0 {
		value := protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_6_list{list: &x.PoolLiabilities})
		if !f(fd_QueryInvariantCustodyLiabResponse_pool_liabilities, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody":
		return len(x.TotalCustody) != 0
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities":
		return len(x.TotalLiabilities) != 0
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy":
		return len(x.TotalCustodyWithoutLazy) != 0
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy":
		return len(x.TotalLiabilitiesWithoutLazy) != 0
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody":
		return len(x.PoolCustody) != 0
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities":
		return len(x.PoolLiabilities) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabResponse"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryInvariantCustodyLiabResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody":
		x.TotalCustody = nil
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities":
		x.TotalLiabilities = nil
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy":
		x.TotalCustodyWithoutLazy = nil
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy":
		x.TotalLiabilitiesWithoutLazy = nil
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody":
		x.PoolCustody = nil
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities":
		x.PoolLiabilities = nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabResponse"))
		}
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody":
		if len(x.TotalCustody) == 0 {
			return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_1_list{})
		}
		listValue := &_QueryInvariantCustodyLiabResponse_1_list{list: &x.TotalCustody}
		return protoreflect.ValueOfList(listValue)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities":
		if len(x.TotalLiabilities) == 0 {
			return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_2_list{})
		}
		listValue := &_QueryInvariantCustodyLiabResponse_2_list{list: &x.TotalLiabilities}
		return protoreflect.ValueOfList(listValue)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy":
		if len(x.TotalCustodyWithoutLazy) == 0 {
			return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_3_list{})
		}
		listValue := &_QueryInvariantCustodyLiabResponse_3_list{list: &x.TotalCustodyWithoutLazy}
		return protoreflect.ValueOfList(listValue)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy":
		if len(x.TotalLiabilitiesWithoutLazy) == 0 {
			return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_4_list{})
		}
		listValue := &_QueryInvariantCustodyLiabResponse_4_list{list: &x.TotalLiabilitiesWithoutLazy}
		return protoreflect.ValueOfList(listValue)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody":
		if len(x.PoolCustody) == 0 {
			return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_5_list{})
		}
		listValue := &_QueryInvariantCustodyLiabResponse_5_list{list: &x.PoolCustody}
		return protoreflect.ValueOfList(listValue)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities":
		if len(x.PoolLiabilities) == 0 {
			return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_6_list{})
		}
		listValue := &_QueryInvariantCustodyLiabResponse_6_list{list: &x.PoolLiabilities}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabResponse"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryInvariantCustodyLiabResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody":
		lv := value.List()
		clv := lv.(*_QueryInvariantCustodyLiabResponse_1_list)
		x.TotalCustody = *clv.list
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities":
		lv := value.List()
		clv := lv.(*_QueryInvariantCustodyLiabResponse_2_list)
		x.TotalLiabilities = *clv.list
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy":
		lv := value.List()
		clv := lv.(*_QueryInvariantCustodyLiabResponse_3_list)
		x.TotalCustodyWithoutLazy = *clv.list
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy":
		lv := value.List()
		clv := lv.(*_QueryInvariantCustodyLiabResponse_4_list)
		x.TotalLiabilitiesWithoutLazy = *clv.list
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody":
		lv := value.List()
		clv := lv.(*_QueryInvariantCustodyLiabResponse_5_list)
		x.PoolCustody = *clv.list
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities":
		lv := value.List()
		clv := lv.(*_QueryInvariantCustodyLiabResponse_6_list)
		x.PoolLiabilities = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabResponse"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody":
		if x.TotalCustody == nil {
			x.TotalCustody = []*v1beta1.Coin{}
		}
		value := &_QueryInvariantCustodyLiabResponse_1_list{list: &x.TotalCustody}
		return protoreflect.ValueOfList(value)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities":
		if x.TotalLiabilities == nil {
			x.TotalLiabilities = []*v1beta1.Coin{}
		}
		value := &_QueryInvariantCustodyLiabResponse_2_list{list: &x.TotalLiabilities}
		return protoreflect.ValueOfList(value)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy":
		if x.TotalCustodyWithoutLazy == nil {
			x.TotalCustodyWithoutLazy = []*v1beta1.Coin{}
		}
		value := &_QueryInvariantCustodyLiabResponse_3_list{list: &x.TotalCustodyWithoutLazy}
		return protoreflect.ValueOfList(value)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy":
		if x.TotalLiabilitiesWithoutLazy == nil {
			x.TotalLiabilitiesWithoutLazy = []*v1beta1.Coin{}
		}
		value := &_QueryInvariantCustodyLiabResponse_4_list{list: &x.TotalLiabilitiesWithoutLazy}
		return protoreflect.ValueOfList(value)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody":
		if x.PoolCustody == nil {
			x.PoolCustody = []*v1beta1.Coin{}
		}
		value := &_QueryInvariantCustodyLiabResponse_5_list{list: &x.PoolCustody}
		return protoreflect.ValueOfList(value)
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities":
		if x.PoolLiabilities == nil {
			x.PoolLiabilities = []*v1beta1.Coin{}
		}
		value := &_QueryInvariantCustodyLiabResponse_6_list{list: &x.PoolLiabilities}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_1_list{list: &list})
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_2_list{list: &list})
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_3_list{list: &list})
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_4_list{list: &list})
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_5_list{list: &list})
	case "elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_QueryInvariantCustodyLiabResponse_6_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryInvariantCustodyLiabResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.QueryInvariantCustodyLiabResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryInvariantCustodyLiabResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryInvariantCustodyLiabResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if len(x.TotalCustody) > 0 {
			for _, e := range x.TotalCustody {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.TotalLiabilities) > 0 {
			for _, e := range x.TotalLiabilities {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.TotalCustodyWithoutLazy) > 0 {
			for _, e := range x.TotalCustodyWithoutLazy {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.TotalLiabilitiesWithoutLazy) > 0 {
			for _, e := range x.TotalLiabilitiesWithoutLazy {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.PoolCustody) > 0 {
			for _, e := range x.PoolCustody {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
		if len(x.PoolLiabilities) > 0 {
			for _, e := range x.PoolLiabilities {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.PoolLiabilities) > 0 {
			for iNdEx := len(x.PoolLiabilities) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.PoolLiabilities[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.PoolCustody) > 0 {
			for iNdEx := len(x.PoolCustody) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.PoolCustody[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.TotalLiabilitiesWithoutLazy) > 0 {
			for iNdEx := len(x.TotalLiabilitiesWithoutLazy) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.TotalLiabilitiesWithoutLazy[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.TotalCustodyWithoutLazy) > 0 {
			for iNdEx := len(x.TotalCustodyWithoutLazy) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.TotalCustodyWithoutLazy[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.TotalLiabilities) > 0 {
			for iNdEx := len(x.TotalLiabilities) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.TotalLiabilities[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
		...
		if len(x.TotalCustody) > 0 {
			for iNdEx := len(x.TotalCustody) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.TotalCustody[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryInvariantCustodyLiabResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryInvariantCustodyLiabResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalCustody", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalCustody = append(x.TotalCustody, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TotalCustody[len(x.TotalCustody)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 2:
				...
				x.TotalLiabilities = append(x.TotalLiabilities, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TotalLiabilities[len(x.TotalLiabilities)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalCustodyWithoutLazy", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalCustodyWithoutLazy = append(x.TotalCustodyWithoutLazy, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TotalCustodyWithoutLazy[len(x.TotalCustodyWithoutLazy)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalLiabilitiesWithoutLazy", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalLiabilitiesWithoutLazy = append(x.TotalLiabilitiesWithoutLazy, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TotalLiabilitiesWithoutLazy[len(x.TotalLiabilitiesWithoutLazy)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PoolCustody", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.PoolCustody = append(x.PoolCustody, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PoolCustody[len(x.PoolCustody)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PoolLiabilities", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.PoolLiabilities = append(x.PoolLiabilities, &v1beta1.Coin{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PoolLiabilities[len(x.PoolLiabilities)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *MTPRequest) GetPoolId() uint64 {
	if x != nil {
		return x.PoolId
	}
	return 0
...
type QueryOpenEstimationResponse struct {
	...
	SwapFees           string        `protobuf:"bytes,20,opt,name=swap_fees,json=swapFees,proto3" json:"swap_fees,omitempty"`
	TakerFees          string        `protobuf:"bytes,21,opt,name=taker_fees,json=takerFees,proto3" json:"taker_fees,omitempty"`
}
...
func (x *QueryOpenEstimationResponse) GetSwapFees() string {
	if x != nil {
		return x.SwapFees
	}
	return ""
...
func (x *QueryOpenEstimationResponse) GetTakerFees() string {
	if x != nil {
		return x.TakerFees
	}
	return ""
...
func (x *QueryCloseEstimationRequest) GetPoolId() uint64 {
	if x != nil {
		return x.PoolId
	}
	return 0
...
type QueryOpenEstimationByFinalRequest struct {
	...
	Position        Position      `protobuf:"varint,1,opt,name=position,proto3,enum=elys.perpetual.Position" json:"position,omitempty"`
	Leverage        string        `protobuf:"bytes,2,opt,name=leverage,proto3" json:"leverage,omitempty"`
	FinalAmount     *v1beta1.Coin `protobuf:"bytes,3,opt,name=final_amount,json=finalAmount,proto3" json:"final_amount,omitempty"`
	Address         string        `protobuf:"bytes,4,opt,name=address,proto3" json:"address,omitempty"`
	TakeProfitPrice string        `protobuf:"bytes,5,opt,name=take_profit_price,json=takeProfitPrice,proto3" json:"take_profit_price,omitempty"`
	PoolId          uint64        `protobuf:"varint,6,opt,name=poolId,proto3" json:"poolId,omitempty"`
...
func (x *QueryOpenEstimationByFinalRequest) Reset() {
	*x = QueryOpenEstimationByFinalRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_perpetual_query_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryOpenEstimationByFinalRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryOpenEstimationByFinalRequest) ProtoMessage() {}

// Deprecated: Use QueryOpenEstimationByFinalRequest.ProtoReflect.Descriptor instead.
func (*QueryOpenEstimationByFinalRequest) Descriptor() ([]byte, []int) {
	return file_elys_perpetual_query_proto_rawDescGZIP(), []int{27}
}

func (x *QueryOpenEstimationByFinalRequest) GetPosition() Position {
	if x != nil {
		return x.Position
	}
	return Position_UNSPECIFIED
...
func (x *QueryOpenEstimationByFinalRequest) GetLeverage() string {
	if x != nil {
		return x.Leverage
	}
	return ""
...
func (x *QueryOpenEstimationByFinalRequest) GetFinalAmount() *v1beta1.Coin {
	if x != nil {
...
func (x *QueryOpenEstimationByFinalRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *QueryOpenEstimationByFinalRequest) GetTakeProfitPrice() string {
	if x != nil {
		return x.TakeProfitPrice
	}
	return ""
...
func (x *QueryOpenEstimationByFinalRequest) GetPoolId() uint64 {
	if x != nil {
		return x.PoolId
	}
	return 0
...
func (x *QueryOpenEstimationByFinalRequest) GetCollateralDenom() string {
	if x != nil {
		return x.CollateralDenom
	}
	return ""
...
type QueryOpenEstimationByFinalResponse struct {
	...
	EffectiveLeverage  string        `protobuf:"bytes,2,opt,name=effective_leverage,json=effectiveLeverage,proto3" json:"effective_leverage,omitempty"`
	Collateral         *v1beta1.Coin `protobuf:"bytes,3,opt,name=collateral,proto3" json:"collateral,omitempty"`
	HourlyInterestRate string        `protobuf:"bytes,4,opt,name=hourly_interest_rate,json=hourlyInterestRate,proto3" json:"hourly_interest_rate,omitempty"`
	PositionSize       *v1beta1.Coin `protobuf:"bytes,5,opt,name=position_size,json=positionSize,proto3" json:"position_size,omitempty"`
	...
	EstimatedPnl       *v1beta1.Coin `protobuf:"bytes,9,opt,name=estimated_pnl,json=estimatedPnl,proto3" json:"estimated_pnl,omitempty"`
	AvailableLiquidity *v1beta1.Coin `protobuf:"bytes,10,opt,name=available_liquidity,json=availableLiquidity,proto3" json:"available_liquidity,omitempty"`
	Slippage           string        `protobuf:"bytes,11,opt,name=slippage,proto3" json:"slippage,omitempty"`
	BorrowInterestRate string        `protobuf:"bytes,12,opt,name=borrow_interest_rate,json=borrowInterestRate,proto3" json:"borrow_interest_rate,omitempty"`
	FundingRate        string        `protobuf:"bytes,13,opt,name=funding_rate,json=fundingRate,proto3" json:"funding_rate,omitempty"`
	PriceImpact        string        `protobuf:"bytes,14,opt,name=price_impact,json=priceImpact,proto3" json:"price_impact,omitempty"`
	Custody            *v1beta1.Coin `protobuf:"bytes,15,opt,name=custody,proto3" json:"custody,omitempty"`
	Liabilities        *v1beta1.Coin `protobuf:"bytes,16,opt,name=liabilities,proto3" json:"liabilities,omitempty"`
	LimitPrice         string        `protobuf:"bytes,17,opt,name=limit_price,json=limitPrice,proto3" json:"limit_price,omitempty"`
	WeightBreakingFee  string        `protobuf:"bytes,18,opt,name=weight_breaking_fee,json=weightBreakingFee,proto3" json:"weight_breaking_fee,omitempty"`
	SwapFees           string        `protobuf:"bytes,19,opt,name=swap_fees,json=swapFees,proto3" json:"swap_fees,omitempty"`
	TakerFees          string        `protobuf:"bytes,20,opt,name=taker_fees,json=takerFees,proto3" json:"taker_fees,omitempty"`
}

func (x *QueryOpenEstimationByFinalResponse) Reset() {
	*x = QueryOpenEstimationByFinalResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_perpetual_query_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryOpenEstimationByFinalResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryOpenEstimationByFinalResponse) ProtoMessage() {}

// Deprecated: Use QueryOpenEstimationByFinalResponse.ProtoReflect.Descriptor instead.
func (*QueryOpenEstimationByFinalResponse) Descriptor() ([]byte, []int) {
	return file_elys_perpetual_query_proto_rawDescGZIP(), []int{28}
}

func (x *QueryOpenEstimationByFinalResponse) GetPosition() Position {
	if x != nil {
		return x.Position
	}
	return Position_UNSPECIFIED
...
func (x *QueryOpenEstimationByFinalResponse) GetEffectiveLeverage() string {
	if x != nil {
		return x.EffectiveLeverage
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetCollateral() *v1beta1.Coin {
	if x != nil {
		return x.Collateral
	}
	return nil
...
func (x *QueryOpenEstimationByFinalResponse) GetHourlyInterestRate() string {
	if x != nil {
		return x.HourlyInterestRate
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetPositionSize() *v1beta1.Coin {
	if x != nil {
		return x.PositionSize
	}
	return nil
...
func (x *QueryOpenEstimationByFinalResponse) GetOpenPrice() string {
	if x != nil {
		return x.OpenPrice
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetTakeProfitPrice() string {
	if x != nil {
		return x.TakeProfitPrice
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetLiquidationPrice() string {
	if x != nil {
		return x.LiquidationPrice
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetEstimatedPnl() *v1beta1.Coin {
	if x != nil {
		return x.EstimatedPnl
	}
	return nil
...
func (x *QueryOpenEstimationByFinalResponse) GetAvailableLiquidity() *v1beta1.Coin {
	if x != nil {
		return x.AvailableLiquidity
	}
	return nil
...
func (x *QueryOpenEstimationByFinalResponse) GetSlippage() string {
	if x != nil {
		return x.Slippage
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetBorrowInterestRate() string {
	if x != nil {
		return x.BorrowInterestRate
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetFundingRate() string {
	if x != nil {
		return x.FundingRate
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetPriceImpact() string {
	if x != nil {
		return x.PriceImpact
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetCustody() *v1beta1.Coin {
	if x != nil {
		return x.Custody
	}
	return nil
...
func (x *QueryOpenEstimationByFinalResponse) GetLiabilities() *v1beta1.Coin {
	if x != nil {
		return x.Liabilities
	}
	return nil
...
func (x *QueryOpenEstimationByFinalResponse) GetLimitPrice() string {
	if x != nil {
		return x.LimitPrice
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetWeightBreakingFee() string {
	if x != nil {
		return x.WeightBreakingFee
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetSwapFees() string {
	if x != nil {
		return x.SwapFees
	}
	return ""
...
func (x *QueryOpenEstimationByFinalResponse) GetTakerFees() string {
	if x != nil {
		return x.TakerFees
	}
	return ""
...
type QueryInvariantCustodyLiabRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueryInvariantCustodyLiabRequest) Reset() {
	*x = QueryInvariantCustodyLiabRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_perpetual_query_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryInvariantCustodyLiabRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryInvariantCustodyLiabRequest) ProtoMessage() {}

// Deprecated: Use QueryInvariantCustodyLiabRequest.ProtoReflect.Descriptor instead.
func (*QueryInvariantCustodyLiabRequest) Descriptor() ([]byte, []int) {
	return file_elys_perpetual_query_proto_rawDescGZIP(), []int{29}
}

func (x *QueryInvariantCustodyLiabRequest) GetPoolId() uint64 {
	if x != nil {
		return x.PoolId
	}
	return 0
...
func (x *QueryInvariantCustodyLiabRequest) GetPagination() *v1beta11.PageRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
type QueryInvariantCustodyLiabResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TotalCustody                []*v1beta1.Coin `protobuf:"bytes,1,rep,name=total_custody,json=totalCustody,proto3" json:"total_custody,omitempty"`
	...
	TotalCustodyWithoutLazy     []*v1beta1.Coin `protobuf:"bytes,3,rep,name=total_custody_without_lazy,json=totalCustodyWithoutLazy,proto3" json:"total_custody_without_lazy,omitempty"`
	TotalLiabilitiesWithoutLazy []*v1beta1.Coin `protobuf:"bytes,4,rep,name=total_liabilities_without_lazy,json=totalLiabilitiesWithoutLazy,proto3" json:"total_liabilities_without_lazy,omitempty"`
	PoolCustody                 []*v1beta1.Coin `protobuf:"bytes,5,rep,name=pool_custody,json=poolCustody,proto3" json:"pool_custody,omitempty"`
	PoolLiabilities             []*v1beta1.Coin `protobuf:"bytes,6,rep,name=pool_liabilities,json=poolLiabilities,proto3" json:"pool_liabilities,omitempty"`
}

func (x *QueryInvariantCustodyLiabResponse) Reset() {
	*x = QueryInvariantCustodyLiabResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_perpetual_query_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryInvariantCustodyLiabResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryInvariantCustodyLiabResponse) ProtoMessage() {}

// Deprecated: Use QueryInvariantCustodyLiabResponse.ProtoReflect.Descriptor instead.
func (*QueryInvariantCustodyLiabResponse) Descriptor() ([]byte, []int) {
	return file_elys_perpetual_query_proto_rawDescGZIP(), []int{30}
}

func (x *QueryInvariantCustodyLiabResponse) GetTotalCustody() []*v1beta1.Coin {
	if x != nil {
		return x.TotalCustody
	}
	return nil
}

func (x *QueryInvariantCustodyLiabResponse) GetTotalLiabilities() []*v1beta1.Coin {
	if x != nil {
		return x.TotalLiabilities
	}
	return nil
...
func (x *QueryInvariantCustodyLiabResponse) GetTotalCustodyWithoutLazy() []*v1beta1.Coin {
	if x != nil {
		return x.TotalCustodyWithoutLazy
	}
	return nil
}

func (x *QueryInvariantCustodyLiabResponse) GetTotalLiabilitiesWithoutLazy() []*v1beta1.Coin {
	if x != nil {
		return x.TotalLiabilitiesWithoutLazy
	}
	return nil
}

func (x *QueryInvariantCustodyLiabResponse) GetPoolCustody() []*v1beta1.Coin {
	if x != nil {
		return x.PoolCustody
	}
	return nil
}

func (x *QueryInvariantCustodyLiabResponse) GetPoolLiabilities() []*v1beta1.Coin {
	if x != nil {
		return x.PoolLiabilities
	}
	return nil
}
...
var file_elys_perpetual_query_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4f, 0x0a, 0x0a, 0x4d, 0x54,
	...
	,
	...
	0x44, 0x65, 0x63, 0x52, 0x08, 0x6c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x3f, 0x0a,
	...
	0x1f, 0x00, 0x52, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x12, 0x18,
	0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x5d, 0x0a, 0x11, 0x74, 0x61, 0x6b, 0x65,
	0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x05, 0x20,
	...
	0x69, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x6f, 0x6f, 0x6c, 0x49,
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x70, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x12,
	0x52, 0x0a, 0x0b, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x07,
	...
	0x69, 0x63, 0x65, 0x22, 0xa6, 0x0d, 0x0a, 0x1b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f, 0x70, 0x65,
	0x6e, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x70, 0x65, 0x72,
	0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x60, 0x0a, 0x12, 0x65, 0x66, 0x66,
	0x65, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x18,
	...
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x11, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74,
	0x69, 0x76, 0x65, 0x4c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x74,
	0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x41, 0x73, 0x73, 0x65, 0x74,
	0x12, 0x3f, 0x0a, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x18, 0x04,
	...
	0x6c, 0x12, 0x63, 0x0a, 0x14, 0x68, 0x6f, 0x75, 0x72, 0x6c, 0x79, 0x5f, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42,
	...
	,
	...
	0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x0f, 0x74, 0x61,
	0x6b, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x5e, 0x0a,
	...
	0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a,
	0x0d, 0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x70, 0x6e, 0x6c, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61,
	0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42,
	0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0c, 0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x64,
	0x50, 0x6e, 0x6c, 0x12, 0x50, 0x0a, 0x13, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65,
	0x5f, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	,
	...
	0x0a, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x4e, 0x0a, 0x0c, 0x63,
	0x6c, 0x6f, 0x73, 0x65, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	,
	...
	0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x0b, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x49, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x12, 0x5e, 0x0a, 0x11, 0x6c, 0x69,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x42, 0x0a, 0x0c, 0x66, 0x69, 0x6e, 0x61,
	0x6c, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52,
	...
	,
	...
	0x61, 0x63, 0x79, 0x44, 0x65, 0x63, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x44, 0x65, 0x63, 0x52, 0x11, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x69, 0x76, 0x65, 0x4c,
	0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x3f, 0x0a, 0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x61,
	0x74, 0x65, 0x72, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0a, 0x63, 0x6f,
	0x6c, 0x6c, 0x61, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x12, 0x63, 0x0a, 0x14, 0x68, 0x6f, 0x75, 0x72,
	...
	0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x12, 0x68, 0x6f, 0x75, 0x72, 0x6c,
	0x79, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x52, 0x61, 0x74, 0x65, 0x12, 0x44, 0x0a,
	0x0d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61,
	0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x42,
	0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x0c, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x69, 0x7a, 0x65, 0x12, 0x50, 0x0a, 0x0a, 0x6f, 0x70, 0x65, 0x6e, 0x5f, 0x70, 0x72, 0x69, 0x63,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6b, 0x2f, 0x65, 0x6c, 0x79, 0x73, 0x2f, 0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c,
	0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x94, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x50,
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x20, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e,
	0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21, 0x2e, 0x65, 0x6c, 0x79,
	0x73, 0x2e, 0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x50, 0x6f, 0x73, 0x69,
	...
	0x75, 0x61, 0x6c, 0x2f, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x7b, 0x70,
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x6b, 0x65, 0x79, 0x7d, 0x12, 0xb7,
	0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42,
	0x79, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x26, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x70, 0x65, 0x72,
	0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x42, 0x79, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e,
	...
	0x79, 0x73, 0x2f, 0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2f, 0x6d, 0x74, 0x70,
	...
	,
	...
	,
...
var file_elys_perpetual_query_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_elys_perpetual_query_proto_goTypes = []interface{}{
	...
	(*QueryOpenEstimationByFinalRequest)(nil),  // 27: elys.perpetual.QueryOpenEstimationByFinalRequest
	(*QueryOpenEstimationByFinalResponse)(nil), // 28: elys.perpetual.QueryOpenEstimationByFinalResponse
	(*QueryInvariantCustodyLiabRequest)(nil),   // 29: elys.perpetual.QueryInvariantCustodyLiabRequest
	(*QueryInvariantCustodyLiabResponse)(nil),  // 30: elys.perpetual.QueryInvariantCustodyLiabResponse
	(*MTP)(nil),                   // 31: elys.perpetual.MTP
	(*v1beta1.Coin)(nil),          // 32: cosmos.base.v1beta1.Coin
	(*Params)(nil),                // 33: elys.perpetual.Params
	(*v1beta11.PageRequest)(nil),  // 34: cosmos.base.query.v1beta1.PageRequest
	(*v1beta11.PageResponse)(nil), // 35: cosmos.base.query.v1beta1.PageResponse
	(*PerpetualCounter)(nil),      // 36: elys.perpetual.PerpetualCounter
	(Position)(0),                 // 37: elys.perpetual.Position
	(*PoolAsset)(nil),             // 38: elys.perpetual.PoolAsset
}
var file_elys_perpetual_query_proto_depIdxs = []int32{
	31, // 0: elys.perpetual.MtpAndPrice.mtp:type_name -> elys.perpetual.MTP
	32, // 1: elys.perpetual.MtpAndPrice.pnl:type_name -> cosmos.base.v1beta1.Coin
	0,  // 2: elys.perpetual.MtpAndPrice.fees:type_name -> elys.perpetual.Fees
	33, // 3: elys.perpetual.ParamsResponse.params:type_name -> elys.perpetual.Params
	34, // 4: elys.perpetual.PositionsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	1,  // 5: elys.perpetual.PositionsResponse.mtps:type_name -> elys.perpetual.MtpAndPrice
	35, // 6: elys.perpetual.PositionsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 7: elys.perpetual.PositionsByPoolRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	1,  // 8: elys.perpetual.PositionsByPoolResponse.mtps:type_name -> elys.perpetual.MtpAndPrice
	35, // 9: elys.perpetual.PositionsByPoolResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	36, // 10: elys.perpetual.PerpetualCounterResponse.result:type_name -> elys.perpetual.PerpetualCounter
	34, // 11: elys.perpetual.PositionsForAddressRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	1,  // 12: elys.perpetual.PositionsForAddressResponse.mtps:type_name -> elys.perpetual.MtpAndPrice
	35, // 13: elys.perpetual.PositionsForAddressResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 14: elys.perpetual.WhitelistRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	35, // 15: elys.perpetual.WhitelistResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	24, // 16: elys.perpetual.QueryGetPoolResponse.pool:type_name -> elys.perpetual.PoolResponse
	34, // 17: elys.perpetual.QueryAllPoolRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	24, // 18: elys.perpetual.QueryAllPoolResponse.pool:type_name -> elys.perpetual.PoolResponse
	35, // 19: elys.perpetual.QueryAllPoolResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	1,  // 20: elys.perpetual.MTPResponse.mtp:type_name -> elys.perpetual.MtpAndPrice
	37, // 21: elys.perpetual.QueryOpenEstimationRequest.position:type_name -> elys.perpetual.Position
	32, // 22: elys.perpetual.QueryOpenEstimationRequest.collateral:type_name -> cosmos.base.v1beta1.Coin
	37, // 23: elys.perpetual.QueryOpenEstimationResponse.position:type_name -> elys.perpetual.Position
	32, // 24: elys.perpetual.QueryOpenEstimationResponse.collateral:type_name -> cosmos.base.v1beta1.Coin
	32, // 25: elys.perpetual.QueryOpenEstimationResponse.position_size:type_name -> cosmos.base.v1beta1.Coin
	32, // 26: elys.perpetual.QueryOpenEstimationResponse.estimated_pnl:type_name -> cosmos.base.v1beta1.Coin
	32, // 27: elys.perpetual.QueryOpenEstimationResponse.available_liquidity:type_name -> cosmos.base.v1beta1.Coin
	32, // 28: elys.perpetual.QueryOpenEstimationResponse.custody:type_name -> cosmos.base.v1beta1.Coin
	32, // 29: elys.perpetual.QueryOpenEstimationResponse.liabilities:type_name -> cosmos.base.v1beta1.Coin
	38, // 30: elys.perpetual.PoolResponse.pool_assets_long:type_name -> elys.perpetual.PoolAsset
	38, // 31: elys.perpetual.PoolResponse.pool_assets_short:type_name -> elys.perpetual.PoolAsset
	32, // 32: elys.perpetual.PoolResponse.total_liabilities:type_name -> cosmos.base.v1beta1.Coin
	37, // 33: elys.perpetual.QueryCloseEstimationResponse.position:type_name -> elys.perpetual.Position
	32, // 34: elys.perpetual.QueryCloseEstimationResponse.position_size:type_name -> cosmos.base.v1beta1.Coin
	32, // 35: elys.perpetual.QueryCloseEstimationResponse.liabilities:type_name -> cosmos.base.v1beta1.Coin
	32, // 36: elys.perpetual.QueryCloseEstimationResponse.borrow_interest_unpaid_liability:type_name -> cosmos.base.v1beta1.Coin
	32, // 37: elys.perpetual.QueryCloseEstimationResponse.returning_amount:type_name -> cosmos.base.v1beta1.Coin
	32, // 38: elys.perpetual.QueryCloseEstimationResponse.paying_liabilities:type_name -> cosmos.base.v1beta1.Coin
	32, // 39: elys.perpetual.QueryCloseEstimationResponse.custody:type_name -> cosmos.base.v1beta1.Coin
	32, // 40: elys.perpetual.QueryCloseEstimationResponse.collateral:type_name -> cosmos.base.v1beta1.Coin
	37, // 41: elys.perpetual.QueryOpenEstimationByFinalRequest.position:type_name -> elys.perpetual.Position
	32, // 42: elys.perpetual.QueryOpenEstimationByFinalRequest.final_amount:type_name -> cosmos.base.v1beta1.Coin
	37, // 43: elys.perpetual.QueryOpenEstimationByFinalResponse.position:type_name -> elys.perpetual.Position
	32, // 44: elys.perpetual.QueryOpenEstimationByFinalResponse.collateral:type_name -> cosmos.base.v1beta1.Coin
	32, // 45: elys.perpetual.QueryOpenEstimationByFinalResponse.position_size:type_name -> cosmos.base.v1beta1.Coin
	32, // 46: elys.perpetual.QueryOpenEstimationByFinalResponse.estimated_pnl:type_name -> cosmos.base.v1beta1.Coin
	32, // 47: elys.perpetual.QueryOpenEstimationByFinalResponse.available_liquidity:type_name -> cosmos.base.v1beta1.Coin
	32, // 48: elys.perpetual.QueryOpenEstimationByFinalResponse.custody:type_name -> cosmos.base.v1beta1.Coin
	32, // 49: elys.perpetual.QueryOpenEstimationByFinalResponse.liabilities:type_name -> cosmos.base.v1beta1.Coin
	34, // 50: elys.perpetual.QueryInvariantCustodyLiabRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	32, // 51: elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody:type_name -> cosmos.base.v1beta1.Coin
	32, // 52: elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities:type_name -> cosmos.base.v1beta1.Coin
	32, // 53: elys.perpetual.QueryInvariantCustodyLiabResponse.total_custody_without_lazy:type_name -> cosmos.base.v1beta1.Coin
	32, // 54: elys.perpetual.QueryInvariantCustodyLiabResponse.total_liabilities_without_lazy:type_name -> cosmos.base.v1beta1.Coin
	32, // 55: elys.perpetual.QueryInvariantCustodyLiabResponse.pool_custody:type_name -> cosmos.base.v1beta1.Coin
	32, // 56: elys.perpetual.QueryInvariantCustodyLiabResponse.pool_liabilities:type_name -> cosmos.base.v1beta1.Coin
	2,  // 57: elys.perpetual.Query.Params:input_type -> elys.perpetual.ParamsRequest
	4,  // 58: elys.perpetual.Query.GetPositions:input_type -> elys.perpetual.PositionsRequest
	6,  // 59: elys.perpetual.Query.GetPositionsByPool:input_type -> elys.perpetual.PositionsByPoolRequest
	8,  // 60: elys.perpetual.Query.PerpetualCounter:input_type -> elys.perpetual.PerpetualCounterRequest
	10, // 61: elys.perpetual.Query.GetPositionsForAddress:input_type -> elys.perpetual.PositionsForAddressRequest
	12, // 62: elys.perpetual.Query.GetWhitelist:input_type -> elys.perpetual.WhitelistRequest
	14, // 63: elys.perpetual.Query.IsWhitelisted:input_type -> elys.perpetual.IsWhitelistedRequest
	16, // 64: elys.perpetual.Query.Pool:input_type -> elys.perpetual.QueryGetPoolRequest
	18, // 65: elys.perpetual.Query.Pools:input_type -> elys.perpetual.QueryAllPoolRequest
	20, // 66: elys.perpetual.Query.MTP:input_type -> elys.perpetual.MTPRequest
	22, // 67: elys.perpetual.Query.OpenEstimation:input_type -> elys.perpetual.QueryOpenEstimationRequest
	25, // 68: elys.perpetual.Query.CloseEstimation:input_type -> elys.perpetual.QueryCloseEstimationRequest
	27, // 69: elys.perpetual.Query.OpenEstimationByFinal:input_type -> elys.perpetual.QueryOpenEstimationByFinalRequest
	29, // 70: elys.perpetual.Query.InvariantCustodyLiab:input_type -> elys.perpetual.QueryInvariantCustodyLiabRequest
	3,  // 71: elys.perpetual.Query.Params:output_type -> elys.perpetual.ParamsResponse
	5,  // 72: elys.perpetual.Query.GetPositions:output_type -> elys.perpetual.PositionsResponse
	7,  // 73: elys.perpetual.Query.GetPositionsByPool:output_type -> elys.perpetual.PositionsByPoolResponse
	9,  // 74: elys.perpetual.Query.PerpetualCounter:output_type -> elys.perpetual.PerpetualCounterResponse
	11, // 75: elys.perpetual.Query.GetPositionsForAddress:output_type -> elys.perpetual.PositionsForAddressResponse
	13, // 76: elys.perpetual.Query.GetWhitelist:output_type -> elys.perpetual.WhitelistResponse
	15, // 77: elys.perpetual.Query.IsWhitelisted:output_type -> elys.perpetual.IsWhitelistedResponse
	17, // 78: elys.perpetual.Query.Pool:output_type -> elys.perpetual.QueryGetPoolResponse
	19, // 79: elys.perpetual.Query.Pools:output_type -> elys.perpetual.QueryAllPoolResponse
	21, // 80: elys.perpetual.Query.MTP:output_type -> elys.perpetual.MTPResponse
	23, // 81: elys.perpetual.Query.OpenEstimation:output_type -> elys.perpetual.QueryOpenEstimationResponse
	26, // 82: elys.perpetual.Query.CloseEstimation:output_type -> elys.perpetual.QueryCloseEstimationResponse
	28, // 83: elys.perpetual.Query.OpenEstimationByFinal:output_type -> elys.perpetual.QueryOpenEstimationByFinalResponse
	30, // 84: elys.perpetual.Query.InvariantCustodyLiab:output_type -> elys.perpetual.QueryInvariantCustodyLiabResponse
...
func file_elys_perpetual_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_elys_perpetual_query_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryOpenEstimationByFinalRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_elys_perpetual_query_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryOpenEstimationByFinalResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_elys_perpetual_query_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryInvariantCustodyLiabRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_elys_perpetual_query_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryInvariantCustodyLiabResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
