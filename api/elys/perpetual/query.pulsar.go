...
var (
	md_QueryGetAllToPayRequest protoreflect.MessageDescriptor
)

func init() {
	file_elys_perpetual_query_proto_init()
	md_QueryGetAllToPayRequest = File_elys_perpetual_query_proto.Messages().ByName("QueryGetAllToPayRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryGetAllToPayRequest)(nil)

type fastReflection_QueryGetAllToPayRequest QueryGetAllToPayRequest

func (x *QueryGetAllToPayRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryGetAllToPayRequest)(x)
}

func (x *QueryGetAllToPayRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryGetAllToPayRequest_messageType fastReflection_QueryGetAllToPayRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryGetAllToPayRequest_messageType{}

type fastReflection_QueryGetAllToPayRequest_messageType struct{}

func (x fastReflection_QueryGetAllToPayRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryGetAllToPayRequest)(nil)
}
func (x fastReflection_QueryGetAllToPayRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryGetAllToPayRequest)
}
func (x fastReflection_QueryGetAllToPayRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryGetAllToPayRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryGetAllToPayRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryGetAllToPayRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryGetAllToPayRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryGetAllToPayRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryGetAllToPayRequest) New() protoreflect.Message {
	return new(fastReflection_QueryGetAllToPayRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryGetAllToPayRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryGetAllToPayRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryGetAllToPayRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryGetAllToPayRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayRequest"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryGetAllToPayRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryGetAllToPayRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayRequest"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryGetAllToPayRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryGetAllToPayRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryGetAllToPayRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.QueryGetAllToPayRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryGetAllToPayRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryGetAllToPayRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryGetAllToPayRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryGetAllToPayRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryGetAllToPayRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryGetAllToPayRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var _ protoreflect.List = (*_QueryGetAllToPayResponse_1_list)(nil)

type _QueryGetAllToPayResponse_1_list struct {
	list *[]*ToPay
}

func (x *_QueryGetAllToPayResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryGetAllToPayResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryGetAllToPayResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ToPay)
	(*x.list)[i] = concreteValue
}

func (x *_QueryGetAllToPayResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*ToPay)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryGetAllToPayResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(ToPay)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryGetAllToPayResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryGetAllToPayResponse_1_list) NewElement() protoreflect.Value {
	v := new(ToPay)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryGetAllToPayResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryGetAllToPayResponse        protoreflect.MessageDescriptor
	fd_QueryGetAllToPayResponse_to_pay protoreflect.FieldDescriptor
)

func init() {
	file_elys_perpetual_query_proto_init()
	md_QueryGetAllToPayResponse = File_elys_perpetual_query_proto.Messages().ByName("QueryGetAllToPayResponse")
	fd_QueryGetAllToPayResponse_to_pay = md_QueryGetAllToPayResponse.Fields().ByName("to_pay")
}

var _ protoreflect.Message = (*fastReflection_QueryGetAllToPayResponse)(nil)

type fastReflection_QueryGetAllToPayResponse QueryGetAllToPayResponse

func (x *QueryGetAllToPayResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryGetAllToPayResponse)(x)
}

func (x *QueryGetAllToPayResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryGetAllToPayResponse_messageType fastReflection_QueryGetAllToPayResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryGetAllToPayResponse_messageType{}

type fastReflection_QueryGetAllToPayResponse_messageType struct{}

func (x fastReflection_QueryGetAllToPayResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryGetAllToPayResponse)(nil)
}
func (x fastReflection_QueryGetAllToPayResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryGetAllToPayResponse)
}
func (x fastReflection_QueryGetAllToPayResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryGetAllToPayResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryGetAllToPayResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryGetAllToPayResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryGetAllToPayResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryGetAllToPayResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryGetAllToPayResponse) New() protoreflect.Message {
	return new(fastReflection_QueryGetAllToPayResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryGetAllToPayResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryGetAllToPayResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryGetAllToPayResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.ToPay) != 0 {
		value := protoreflect.ValueOfList(&_QueryGetAllToPayResponse_1_list{list: &x.ToPay})
		if !f(fd_QueryGetAllToPayResponse_to_pay, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryGetAllToPayResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "elys.perpetual.QueryGetAllToPayResponse.to_pay":
		return len(x.ToPay) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayResponse"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryGetAllToPayResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "elys.perpetual.QueryGetAllToPayResponse.to_pay":
		x.ToPay = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryGetAllToPayResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "elys.perpetual.QueryGetAllToPayResponse.to_pay":
		if len(x.ToPay) == 0 {
			return protoreflect.ValueOfList(&_QueryGetAllToPayResponse_1_list{})
		}
		listValue := &_QueryGetAllToPayResponse_1_list{list: &x.ToPay}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayResponse"))
		}
		panic(fmt.Errorf("message elys.perpetual.QueryGetAllToPayResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "elys.perpetual.QueryGetAllToPayResponse.to_pay":
		lv := value.List()
		clv := lv.(*_QueryGetAllToPayResponse_1_list)
		x.ToPay = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryGetAllToPayResponse.to_pay":
		if x.ToPay == nil {
			x.ToPay = []*ToPay{}
		}
		value := &_QueryGetAllToPayResponse_1_list{list: &x.ToPay}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryGetAllToPayResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "elys.perpetual.QueryGetAllToPayResponse.to_pay":
		list := []*ToPay{}
		return protoreflect.ValueOfList(&_QueryGetAllToPayResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: elys.perpetual.QueryGetAllToPayResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryGetAllToPayResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in elys.perpetual.QueryGetAllToPayResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryGetAllToPayResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryGetAllToPayResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryGetAllToPayResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryGetAllToPayResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryGetAllToPayResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ToPay) > 0 {
			for iNdEx := len(x.ToPay) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.ToPay[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryGetAllToPayResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryGetAllToPayResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ToPay", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ToPay = append(x.ToPay, &ToPay{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ToPay[len(x.ToPay)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *QueryGetAllToPayRequest) Reset() {
	*x = QueryGetAllToPayRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_perpetual_query_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryGetAllToPayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryGetAllToPayRequest) ProtoMessage() {}

// Deprecated: Use QueryGetAllToPayRequest.ProtoReflect.Descriptor instead.
...
func (x *QueryGetAllToPayResponse) Reset() {
	*x = QueryGetAllToPayResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_elys_perpetual_query_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryGetAllToPayResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryGetAllToPayResponse) ProtoMessage() {}

// Deprecated: Use QueryGetAllToPayResponse.ProtoReflect.Descriptor instead.
func (*QueryGetAllToPayResponse) Descriptor() ([]byte, []int) {
	return file_elys_perpetual_query_proto_rawDescGZIP(), []int{25}
}

func (x *QueryGetAllToPayResponse) GetToPay() []*ToPay {
	if x != nil {
		return x.ToPay
	}
	return nil
...
var file_elys_perpetual_query_proto_rawDesc = []byte{
	...
	,
	...
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x70, 0x65,
	...
	0x61, 0x73, 0x73, 0x65, 0x74, 0x73, 0x5f, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x18, 0x05, 0x20, 0x03,
	...
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x24, 0x6c, 0x61, 0x73, 0x74, 0x48, 0x65, 0x69,
	...
	0x0c, 0x66, 0x75, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x1b, 0x63, 0x6f, 0x73,
	0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x4c,
	0x65, 0x67, 0x61, 0x63, 0x79, 0x44, 0x65, 0x63, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2b,
	...
	,
	...
	0x69, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e,
	...
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2b,
	0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x15, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64,
	0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x49, 0x6e, 0x74, 0xd2, 0xb4, 0x2d,
	...
	0x65, 0x6e, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x22, 0xa8, 0x01, 0x0a, 0x1b, 0x51,
	...
	0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x4c, 0x65, 0x67,
	0x61, 0x63, 0x79, 0x44, 0x65, 0x63, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x44, 0x65, 0x63, 0x52, 0x08, 0x73, 0x6c, 0x69, 0x70, 0x70, 0x61, 0x67, 0x65, 0x32, 0xb7,
	0x0f, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x74, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61,
	...
	0x6e, 0x2d, 0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x95, 0x01, 0x0a,
	0x0b, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x54, 0x6f, 0x50, 0x61, 0x79, 0x12, 0x27, 0x2e, 0x65,
	0x6c, 0x79, 0x73, 0x2e, 0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x54, 0x6f, 0x50, 0x61, 0x79, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x28, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x70, 0x65, 0x72,
	0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x65, 0x74, 0x41,
	0x6c, 0x6c, 0x54, 0x6f, 0x50, 0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	...
	0x65, 0x74, 0x75, 0x61, 0x6c, 0x2f, 0x67, 0x65, 0x74, 0x5f, 0x61, 0x6c, 0x6c, 0x5f, 0x74, 0x6f,
	0x5f, 0x70, 0x61, 0x79, 0x12, 0xb1, 0x01, 0x0a, 0x0f, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x45, 0x73,
	0x74, 0x69, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2b, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e,
	0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x43,
	0x6c, 0x6f, 0x73, 0x65, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x65, 0x6c, 0x79, 0x73, 0x2e, 0x70, 0x65, 0x72,
	0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x43, 0x6c, 0x6f, 0x73,
	...
	0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x2f, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x2d,
	0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x7b, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x9a, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d,
	...
	0x65, 0x6c, 0x79, 0x73, 0x2f, 0x70, 0x65, 0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0xa2, 0x02,
	0x03, 0x45, 0x50, 0x58, 0xaa, 0x02, 0x0e, 0x45, 0x6c, 0x79, 0x73, 0x2e, 0x50, 0x65, 0x72, 0x70,
	0x65, 0x74, 0x75, 0x61, 0x6c, 0xca, 0x02, 0x0e, 0x45, 0x6c, 0x79, 0x73, 0x5c, 0x50, 0x65, 0x72,
	0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0xe2, 0x02, 0x1a, 0x45, 0x6c, 0x79, 0x73, 0x5c, 0x50, 0x65,
	0x72, 0x70, 0x65, 0x74, 0x75, 0x61, 0x6c, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0xea, 0x02, 0x0f, 0x45, 0x6c, 0x79, 0x73, 0x3a, 0x3a, 0x50, 0x65, 0x72, 0x70,
	0x65, 0x74, 0x75, 0x61, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_elys_perpetual_query_proto_goTypes = []interface{}{
	...
	(*QueryGetAllToPayRequest)(nil),      // 24: elys.perpetual.QueryGetAllToPayRequest
	(*QueryGetAllToPayResponse)(nil),     // 25: elys.perpetual.QueryGetAllToPayResponse
	(*PoolResponse)(nil),                 // 26: elys.perpetual.PoolResponse
	(*QueryCloseEstimationRequest)(nil),  // 27: elys.perpetual.QueryCloseEstimationRequest
	(*QueryCloseEstimationResponse)(nil), // 28: elys.perpetual.QueryCloseEstimationResponse
	...
	(Position)(0),                        // 34: elys.perpetual.Position
	(*ToPay)(nil),                        // 35: elys.perpetual.ToPay
...
var file_elys_perpetual_query_proto_depIdxs = []int32{
	...
	32, // 10: elys.perpetual.PositionsForAddressRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	1,  // 11: elys.perpetual.PositionsForAddressResponse.mtps:type_name -> elys.perpetual.MtpAndPrice
	33, // 12: elys.perpetual.PositionsForAddressResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	32, // 13: elys.perpetual.WhitelistRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	33, // 14: elys.perpetual.WhitelistResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	26, // 15: elys.perpetual.QueryGetPoolResponse.pool:type_name -> elys.perpetual.PoolResponse
	32, // 16: elys.perpetual.QueryAllPoolRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	26, // 17: elys.perpetual.QueryAllPoolResponse.pool:type_name -> elys.perpetual.PoolResponse
	33, // 18: elys.perpetual.QueryAllPoolResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	1,  // 19: elys.perpetual.MTPResponse.mtp:type_name -> elys.perpetual.MtpAndPrice
	34, // 20: elys.perpetual.QueryOpenEstimationRequest.position:type_name -> elys.perpetual.Position
	30, // 21: elys.perpetual.QueryOpenEstimationRequest.collateral:type_name -> cosmos.base.v1beta1.Coin
	34, // 22: elys.perpetual.QueryOpenEstimationResponse.position:type_name -> elys.perpetual.Position
	30, // 23: elys.perpetual.QueryOpenEstimationResponse.collateral:type_name -> cosmos.base.v1beta1.Coin
	30, // 24: elys.perpetual.QueryOpenEstimationResponse.position_size:type_name -> cosmos.base.v1beta1.Coin
	30, // 25: elys.perpetual.QueryOpenEstimationResponse.estimated_pnl:type_name -> cosmos.base.v1beta1.Coin
	30, // 26: elys.perpetual.QueryOpenEstimationResponse.available_liquidity:type_name -> cosmos.base.v1beta1.Coin
	30, // 27: elys.perpetual.QueryOpenEstimationResponse.custody:type_name -> cosmos.base.v1beta1.Coin
	30, // 28: elys.perpetual.QueryOpenEstimationResponse.liabilities:type_name -> cosmos.base.v1beta1.Coin
	35, // 29: elys.perpetual.QueryGetAllToPayResponse.to_pay:type_name -> elys.perpetual.ToPay
	...
	34, // 33: elys.perpetual.QueryCloseEstimationResponse.position:type_name -> elys.perpetual.Position
	...
	8,  // 44: elys.perpetual.Query.GetStatus:input_type -> elys.perpetual.StatusRequest
	...
	24, // 52: elys.perpetual.Query.GetAllToPay:input_type -> elys.perpetual.QueryGetAllToPayRequest
	27, // 53: elys.perpetual.Query.CloseEstimation:input_type -> elys.perpetual.QueryCloseEstimationRequest
	3,  // 54: elys.perpetual.Query.Params:output_type -> elys.perpetual.ParamsResponse
	5,  // 55: elys.perpetual.Query.GetPositions:output_type -> elys.perpetual.PositionsResponse
	7,  // 56: elys.perpetual.Query.GetPositionsByPool:output_type -> elys.perpetual.PositionsByPoolResponse
	9,  // 57: elys.perpetual.Query.GetStatus:output_type -> elys.perpetual.StatusResponse
	11, // 58: elys.perpetual.Query.GetPositionsForAddress:output_type -> elys.perpetual.PositionsForAddressResponse
	13, // 59: elys.perpetual.Query.GetWhitelist:output_type -> elys.perpetual.WhitelistResponse
	15, // 60: elys.perpetual.Query.IsWhitelisted:output_type -> elys.perpetual.IsWhitelistedResponse
	17, // 61: elys.perpetual.Query.Pool:output_type -> elys.perpetual.QueryGetPoolResponse
	19, // 62: elys.perpetual.Query.Pools:output_type -> elys.perpetual.QueryAllPoolResponse
	21, // 63: elys.perpetual.Query.MTP:output_type -> elys.perpetual.MTPResponse
	23, // 64: elys.perpetual.Query.OpenEstimation:output_type -> elys.perpetual.QueryOpenEstimationResponse
	25, // 65: elys.perpetual.Query.GetAllToPay:output_type -> elys.perpetual.QueryGetAllToPayResponse
	28, // 66: elys.perpetual.Query.CloseEstimation:output_type -> elys.perpetual.QueryCloseEstimationResponse
...
func file_elys_perpetual_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_elys_perpetual_query_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryGetAllToPayRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_elys_perpetual_query_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryGetAllToPayResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
