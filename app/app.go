...
func NewElysApp(
	...
	*/
	...
	wasmOpts = append(RegisterCustomPlugins(&app.AmmKeeper, &app.OracleKeeper, &app.MarginKeeper, app.BankKeeper.(*bankkeeper.BaseKeeper), app.StakingKeeper, &app.CommitmentKeeper), wasmOpts...)
