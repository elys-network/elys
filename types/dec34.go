...
func (d Dec34) Quo(other Dec34) Dec34 {
	res, err := regenmath.Dec(d).Quo(regenmath.Dec(other))
	if err != nil {
		panic(err)
	}
	return Dec34(res)
...
func (d Dec34) Add(other Dec34) Dec34 {
	res, err := regenmath.Dec(d).Add(regenmath.Dec(other))
	if err != nil {
		panic(err)
	}
	return Dec34(res)
...
func (d Dec34) Sub(other Dec34) Dec34 {
	res, err := regenmath.Dec(d).Sub(regenmath.Dec(other))
	if err != nil {
		panic(err)
	}
	return Dec34(res)
